...
# Menu del Corso — I Contenitori dell'Informatica {#doc6}
*Versione 0.1 · 10/09/2026 · Parte: Riferimento*

## 1. Come si legge questo menu {#doc6-sec1}
1. Ogni sezione e un **contenitore**: una scatola con dentro argomenti che si assomigliano (per esempio "Reti", oppure "Programmazione e videogiochi").
2. Per ogni contenitore trovi tre cose semplici:
   1. **Che cos'e**: di cosa parla, spiegato in poche parole.
   2. **Cosa puoi costruire**: le cose concrete e "belle da mostrare" che nascono da qui.
   3. **A cosa ti serve**: dove torna utile nel lavoro e nella vita.
3. Non e un ordine e non e un obbligo: e un **magazzino ordinato** da cui, insieme, peschiamo di volta in volta.
4. Alcuni contenitori li vediamo tanto, altri solo come assaggio: dipende dall'anno e da quello che vi accende di piu.

> [GIALLO] Come funziona il metodo (la promessa): si parte sempre da qualcosa che funziona subito a schermo o tra le mani (vinci subito), poi lo rendi tuo scegliendo un colore, un nome, un'idea (fallo tuo), e alla fine lo fai vedere a un compagno o sul telefono (mostralo). L'errore non fa danno e non fa vergogna: capita a tutti, anche ai professionisti.

## 2. Il viaggio in quattro anni (dal "tutto" alla tua strada) {#doc6-sec2}
Il menu non e uguale ogni anno. Funziona come un **imbuto**: largo all'inizio,
poi si stringe verso quello che diventa **tuo**.

1. **Prima — le fondamenta.** Qui si costruisce la base che serve a tutti: si assaggia un po' di ogni scatola e si imparano le cose senza le quali il resto non sta in piedi. E l'anno piu importante per partire bene.
2. **Seconda e terza — le vie di mezzo.** Si va piu a fondo nelle scatole, si fanno i primi progetti seri e si comincia a capire cosa ti piace e cosa ti riesce meglio.
3. **Quarta — scegli la tua strada.** Non si fa piu tutto: si scelgono **una o due** scatole e ci si specializza, per arrivare pronti al lavoro con qualcosa in cui sei bravo davvero.

| Anno | Come e il menu | In una frase |
|---|---|---|
| Prima | Largo: le fondamenta di tutto | "Assaggio e imparo le basi" |
| Seconda | Si approfondisce | "Capisco cosa mi piace" |
| Terza | Si approfondisce ancora, primi progetti seri | "Divento piu bravo" |
| Quarta | Stretto: una o due scelte | "Scelgo la mia strada" |

> [GIALLO] L'idea da portare a casa: nessuno resta indietro, perche in prima si parte tutti dalle stesse fondamenta. E nessuno resta imprigionato in una scelta fatta troppo presto, perche la strada la scegli alla fine, quando sai gia cosa fa per te.

## 3. Fondamenta dell'informatica {#doc6-sec3}
1. **Che cos'e**: come funziona davvero un computer dentro, i "numeri del computer" (il codice binario, i bit e i byte), come si organizzano file e cartelle e come si gestisce il proprio tempo di lavoro.
2. **Cosa puoi costruire**: il tuo spazio di lavoro ordinato (cartelle ad albero), un glossario dei termini costruito da voi, i primi schemi di come nasce e viaggia l'informazione.
3. **A cosa ti serve**: e l'alfabeto di tutto il resto. Senza queste basi ogni altra scatola diventa piu difficile.

## 4. Hardware: montare, curare e riparare il PC {#doc6-sec4}
1. **Che cos'e**: cosa c'e dentro un computer (processore, memoria, schede), come si sceglie ogni pezzo e come si assembla; e come si capisce e si aggiusta un PC che non va (la "diagnosi guasti", in inglese troubleshooting).
2. **Cosa puoi costruire**: un PC configurato da te a un certo budget; e, con i guasti preparati apposta, diventare quello che trova il problema e lo risolve con le sue mani.
3. **A cosa ti serve**: e un mestiere vero e sempre richiesto. Chi sa mettere le mani nell'hardware trova lavoro.

## 5. Il sistema operativo {#doc6-sec5}
1. **Che cos'e**: il programma che fa funzionare tutto il resto (Windows): finestre, file e cartelle, installare e configurare.
2. **Cosa puoi costruire**: sapere installare e sistemare un sistema da zero, tenere in ordine i tuoi file, non aver piu paura di "toccare le impostazioni".
3. **A cosa ti serve**: e la cassetta degli attrezzi di ogni giorno, a scuola, a casa e al lavoro.

## 6. Produttivita digitale (la suite di Google) {#doc6-sec6}
1. **Che cos'e**: gli strumenti per lavorare bene con documenti, tabelle, presentazioni e posta: Documenti, Fogli, Presentazioni, Moduli, Gmail, Calendar.
2. **Cosa puoi costruire**: un preventivo che si calcola da solo con le formule dei Fogli, una presentazione che convince, una mail formale scritta come si deve.
3. **A cosa ti serve**: sono gli strumenti che userai in qualunque lavoro d'ufficio o tecnico. Saperli usare bene fa la differenza.

## 7. Reti {#doc6-sec7}
1. **Che cos'e**: come i computer si parlano tra loro: la rete di casa, il Wi-Fi, i cavi, come "viaggiano i dati" a pacchetti, l'indirizzo IP.
2. **Cosa puoi costruire**: costruire un cavo di rete con le tue mani (cablaggio RJ45), collegare una piccola rete e provarla, disegnare la rete di una scuola con un simulatore (Cisco Packet Tracer).
3. **A cosa ti serve**: il tecnico di rete e una delle figure piu cercate. Qui inizia quel percorso.

## 8. Programmazione, logica e videogiochi {#doc6-sec8}
1. **Che cos'e**: imparare a dare ordini al computer, passo dopo passo. Si parte dalla logica (gli algoritmi, le condizioni "se... allora..."), si passa a Lazarus (come l'anno scorso) e si arriva a creare **videogiochi** con Godot.
2. **Cosa puoi costruire**: un tuo videogioco personalizzato (personaggio, colori, nome tuoi) da mostrare e far giocare; piccoli programmi che reagiscono e decidono da soli.
3. **A cosa ti serve**: e il cuore dell'informatica. Chi sa programmare puo costruire quasi tutto il resto.

> [GIALLO] Le condizioni "se... allora..." (in inglese if/then/else) partono da cose che gia conosci: le automazioni tipo IFTTT, la funzione SE dei Fogli Google e gli esempi dai social. Poi le scrivi nel codice. E lo stesso ragionamento a passi che usano anche gli assistenti AI.

## 9. Database e gestione dei dati {#doc6-sec9}
1. **Che cos'e**: come si conservano e si cercano tanti dati in modo ordinato (un archivio digitale, come una biblioteca) e il linguaggio per interrogarli (SQL).
2. **Cosa puoi costruire**: il "magazzino" di un negozio online che ricorda prodotti e ordini; ricerche che tirano fuori esattamente il dato che ti serve.
3. **A cosa ti serve**: dietro ogni app e ogni sito serio c'e un database. E una competenza molto spendibile.

## 10. Web e realizzazione di siti {#doc6-sec10}
1. **Che cos'e**: come si costruisce una pagina web (HTML5 e CSS, cioe la struttura e il "vestito" grafico) e come si mette online.
2. **Cosa puoi costruire**: il tuo primo sito, pubblicato davvero su internet (con GitHub Pages) e mostrabile a chiunque con un link; una pagina personale o un piccolo sito professionale.
3. **A cosa ti serve**: avere qualcosa di tuo online e un biglietto da visita. E il web e ovunque.

## 11. Grafica e multimedia {#doc6-sec11}
1. **Che cos'e**: creare immagini, loghi, locandine e video (per esempio con Canva); capire come lo schermo "disegna" con le coordinate.
2. **Cosa puoi costruire**: il logo e la locandina del tuo progetto o del tuo gioco, un breve video di presentazione, materiali che fanno una bella figura.
3. **A cosa ti serve**: saper comunicare con le immagini serve in ogni progetto, e apre alla parte piu creativa del mestiere.

## 12. Robotica, elettronica e making {#doc6-sec12}
1. **Che cos'e**: far muovere e "ragionare" oggetti reali con l'elettronica: schede come Arduino, i mattoncini programmabili Lego, la stampa 3D.
2. **Cosa puoi costruire**: un semaforo a LED, un sensore che reagisce, piccoli robot e oggetti stampati in 3D.
3. **A cosa ti serve**: e il ponte tra il codice e il mondo fisico, la porta verso l'automazione e l'Industria 4.0.

> [BLU] Questa scatola, nel nostro istituto, si fa in laboratorio con un docente dedicato: entra nel vostro percorso, ma non nelle ore del prof. Regge. E qui per darvi il quadro completo di cosa tocca l'indirizzo.

## 13. Sicurezza e cittadinanza digitale {#doc6-sec13}
1. **Che cos'e**: come stare sicuri e comportarsi bene nel mondo digitale: password robuste, riconoscere le truffe (phishing), proteggere i propri dati e la privacy, rispetto e netiquette online.
2. **Cosa puoi costruire**: le tue "regole d'oro" per non farti fregare; smascherare una mail-truffa preparata apposta; capire cosa concedi quando accetti i permessi di un'app.
3. **A cosa ti serve**: e la difesa di te stesso e, un domani, dei clienti e dell'azienda per cui lavorerai. Si lega al lavoro che faremo per colmare le lacune emerse dalle prove.

> [ROSSO] Attenzione a non confondere: questa "sicurezza" e quella del comportamento da utente (come proteggersi). La sicurezza informatica tecnica vera e propria (crittografia, firewall) e una parte piu avanzata e diversa, che si tocca negli anni superiori.

## 14. Intelligenza artificiale {#doc6-sec14}
1. **Che cos'e**: usare bene l'AI per studiare e lavorare. La differenza tra un assistente personalizzato (il "Gem" in Gemini) che **risponde** e un agente che **agisce** al posto tuo.
2. **Cosa puoi costruire**: il tuo tutor personale (per esempio "interrogami sui verbi e fammi un quiz alla fine"), creato scrivendo poche righe di istruzioni; capire quando conviene un assistente e quando un agente.
3. **A cosa ti serve**: saper usare l'AI e gia una competenza. La regola resta una: l'AI aiuta a **capire**, non a saltare il pensiero.

> [GIALLO] La prova del nove vale sempre: se sai raccontare a parole tue cosa hai fatto e perche, allora hai capito davvero, anche se ti sei fatto aiutare.

## 15. Mondo del lavoro e lavorare in squadra {#doc6-sec15}
1. **Che cos'e**: come si organizza un progetto (chi fa cosa, i tempi), come si lavora in team, come ci si presenta al lavoro (il CV in formato Europass).
2. **Cosa puoi costruire**: un progetto di gruppo dove ognuno ha il suo ruolo e i pezzi si uniscono (proprio come in una vera azienda, usando Git); il tuo primo curriculum.
3. **A cosa ti serve**: nessuno lavora da solo. Saper collaborare e presentarsi vale quanto le competenze tecniche.

## 16. I nostri progetti-bandiera (dove tante scatole si incontrano) {#doc6-sec16}
Alcune cose che facciamo mettono insieme piu contenitori in un colpo solo, e
sono quelle di cui andare piu fieri.
1. **Il Mio Negozio Online**: una vetrina web con il suo magazzino di dati e gli ordini via email. Tocca web, database, SQL e lavoro in squadra con Git.
2. **I giochi con Godot**: dai primi giochini semplici a progetti piu ricchi, ognuno personalizzato e giocabile, con il tuo quaderno che racconta come li hai fatti.
3. **Cablaggio e prime reti**: costruire cavi e collegare una piccola rete, con schede a livelli di aiuto per andare al tuo passo.

## 17. E adesso? {#doc6-sec17}
1. Non serve decidere niente oggi: questo menu serve a **vedere** cosa c'e e a farti venire voglia.
2. Cominciamo dalle fondamenta e da qualche vittoria veloce; strada facendo capirai quali scatole ti accendono di piu.
3. Ogni cosa che costruisci finisce nel tuo **quaderno personale**: a fine percorso avrai un libro tuo, di cui essere fiero, da mostrare anche a chi ti dara un lavoro.

> [GIALLO] Prendi carta e penna e prova un gioco: scorri i contenitori e segna con una stellina i due o tre che, a pancia, ti attirano di piu. Non e una scelta definitiva, e solo un primo ascolto di cosa ti incuriosisce.
...
## 2. Fondamenti e cultura informatica {#doc7-sec2}
...
## 3. Hardware: architettura, assemblaggio, manutenzione e diagnosi {#doc7-sec3}
...
## 5. Produttivita digitale (Google Workspace e Office) {#doc7-sec5}
...
## 6. Grafica e multimedia {#doc7-sec6}
...
## 8. Programmazione, logica e algoritmi {#doc7-sec8}
...
## 10. Web e realizzazione di siti {#doc7-sec10}
...
## 11. Intelligenza artificiale {#doc7-sec11}
...
## 12. Mondo del lavoro, project management e documentazione {#doc7-sec12}
...
## 13. Progetti pratici del corso (nostri) {#doc7-sec13}
...
# Piano delle Ore di Lezione — guida giorno per giorno {#doc8}
*Versione 0.4 · 18/08/2026 · Parte: Riferimento*

## 0. Regola fissa di OGNI lezione: carta e penna (tassativo) {#doc8-sec1}
...
## 1. Come si usa questo documento {#doc8-sec2}
...
## 2. Legenda dei simboli {#doc8-sec3}
...
## Fili rossi dell'anno (tornano in molte lezioni) {#doc8-sec4}
...
## Macro-area: Fondamenti e cultura informatica {#doc8-sec5}
...
## Macro-area: Produttivita digitale (Google Workspace) {#doc8-sec6}
...
## Macro-area: Hardware (architettura, assemblaggio, diagnosi) {#doc8-sec7}
...
## Macro-area: Reti (parte teorica) {#doc8-sec8}
...
## Macro-area: Grafica e multimedia {#doc8-sec9}
...
## Macro-area: Programmazione, logica e algoritmi {#doc8-sec10}
...
## Macro-area: Intelligenza artificiale [FILO ROSSO] {#doc8-sec11}
...
## Fili rossi dell'anno {#doc8-sec12}
...
## Macro-area: Sistema operativo {#doc8-sec13}
...
## Macro-area: Grafica e multimedia {#doc8-sec14}
...
## Macro-area: Programmazione (Lazarus) {#doc8-sec15}
...
## Macro-area: Mondo del lavoro {#doc8-sec17}
...
## Macro-area: Progetti pratici {#doc8-sec18}
...
## Macro-area: Intelligenza artificiale [FILO ROSSO] {#doc8-sec19}
...
## Fili rossi dell'anno {#doc8-sec20}
...
## Macro-area: Database e gestione dei dati {#doc8-sec21}
...
## Macro-area: Web e realizzazione di siti {#doc8-sec22}
...
## Macro-area: Programmazione (Lazarus e oltre) {#doc8-sec24}
...
## Macro-area: Mondo del lavoro {#doc8-sec25}
...
## Macro-area: Progetti pratici {#doc8-sec26}
...
## Macro-area: Intelligenza artificiale [FILO ROSSO] {#doc8-sec27}
...
## Fili rossi dell'anno {#doc8-sec28}
...
## Macro-area: Reti (il cuore pulsante dell'anno) {#doc8-sec29}
...
## Macro-area: Database e gestione dei dati (approfondimento) {#doc8-sec30}
...
## Macro-area: Web (siti piu completi) {#doc8-sec31}
...
## Macro-area: Programmazione (livello massimo) {#doc8-sec32}
...
## Macro-area: Mondo del lavoro {#doc8-sec33}
...
## Macro-area: Intelligenza artificiale [FILO ROSSO] {#doc8-sec34}
...
# Organizzazione Git per gli Allievi {#doc9}
...
## 1. A cosa serve e perche (il senso) {#doc9-sec1}
...
## 2. La struttura (tre livelli + area comune) {#doc9-sec2}
...
## 3. Perche GitHub Classroom {#doc9-sec3}
...
## 4. Il repository modello (template): cosa contiene {#doc9-sec4}
...
## 5. Ruoli e permessi: chi vede cosa {#doc9-sec5}
...
## 6. Come si lega alle due fasi del corso {#doc9-sec6}
...
## 7. Come si imposta (a grandi linee, una tantum) {#doc9-sec7}
...
## 8. Nomi di esempio (da adattare) {#doc9-sec8}
...
## 9. Cosa serve prima di partire {#doc9-sec9}
...
## 10. Privacy e dignita (perche lo facciamo cosi) {#doc9-sec10}
...
## 11. Punti ancora aperti {#doc9-sec11}
...
## 12. Stato dell'attivazione (aggiornato 02/09/2026) {#doc9-sec12}
...
# Regole del Laboratorio di Informatica {#doc10}
*Versione 0.1 · 18/08/2026 · Parte: Riferimento*

## 1. Lo spirito del laboratorio (perche ci sono queste regole) {#doc10-sec1}
...
## 2. Quando entri (all'inizio della lezione) {#doc10-sec2}
...
## 3. La postazione e i dispositivi (averne cura) {#doc10-sec3}
...
## 4. Come si sta insieme (rispetto) {#doc10-sec4}
...
## 5. Internet, telefono e intelligenza artificiale (uso consapevole) {#doc10-sec5}
...
## 6. Il tuo lavoro (salvarlo bene) {#doc10-sec6}
...
## 7. Quando esci (fine lezione) {#doc10-sec7}
...
## 8. Se dimentichi qualcosa {#doc10-sec8}
...
## 9. Le regole in breve (versione da appendere in aula) {#doc10-sec9}
...
# Regolamento — Strumenti Informatici, Servizi Digitali e IA Generativa {#doc11}
*Versione 0.1 · 16/09/2026 · Parte: Riferimento*

## 1. Premessa e scopo {#doc11-sec1}
1. Questo regolamento vale in laboratorio e ogni volta che si usano gli strumenti informatici e i servizi digitali della scuola.
2. Serve a stare bene e a lavorare bene insieme: il laboratorio e lo spazio di tutti e, se ognuno ne ha cura, funziona per tutti.
3. Lo spirito e quello del corso: si prova senza paura, sbagliare e normale, ci si tratta con rispetto (docente e allievi, e allievi tra loro).
4. Non sostituisce il regolamento d'istituto: ne e una parte specifica per l'informatica, i servizi digitali e l'IA.

> [BLU] Da coordinare con la scuola: questo testo va allineato al regolamento d'istituto e alle sue eventuali misure disciplinari. Il docente adatta le voci dove serve (per esempio uso del telefono, sanzioni, procedure).

## 2. Le postazioni e gli strumenti informatici {#doc11-sec2}
1. La postazione si tratta con cura, come se fosse propria: la si usa anche la prossima volta.
2. Non si installano programmi e non si cambiano le impostazioni del sistema senza il docente.
3. Non si staccano cavi e non si spostano pezzi del computer senza il docente.
4. Se qualcosa non funziona, lo si segnala subito: un guasto e normale, nasconderlo no. Non e colpa di chi lo trova.
5. Cibi e bevande restano lontani da computer e tastiere.

## 3. Account, credenziali e password {#doc11-sec3}
1. Ogni allievo ha una propria utenza personale: si usa la propria, mai quella di un altro.
2. La password e personale e segreta: non si dice a nessuno, nemmeno agli amici.
3. La password deve essere robusta (lunga e difficile da indovinare) e non si riusa la stessa su servizi diversi.
4. Non si scrivono le password su fogli o quaderni lasciati in giro.
5. A fine lezione si esce dal proprio account (logout), soprattutto sulle postazioni condivise.

## 4. Rete e internet {#doc11-sec4}
1. Internet si usa per le attivita della lezione.
2. Non si visitano siti offensivi, illegali o inadatti all'ambiente scolastico.
3. Non si scaricano programmi o file non richiesti dall'attivita.
4. Si rispetta il diritto d'autore: non si spacciano per propri testi, immagini o musiche di altri.

## 5. Dati personali, privacy e immagini {#doc11-sec5}
1. Non si diffondono dati personali, propri o altrui (indirizzi, numeri, foto), senza consenso.
...
## 6. I servizi digitali della scuola (account, Drive, posta) {#doc11-sec6}
1. L'account e i servizi della scuola (per esempio Google Drive e la posta) si usano per scopi didattici.
2. I file di lavoro si tengono in ordine nella propria area personale.
3. La posta e i messaggi si scrivono con educazione (netiquette): niente offese, niente maiuscolo per urlare.
4. Non si accede allo spazio o ai file di un altro allievo senza permesso.

## 7. Intelligenza artificiale generativa (uso consapevole) {#doc11-sec7}
1. Che cos'e: strumenti che generano testi o immagini a partire da una richiesta (per esempio assistenti come quelli che useremo in classe). Sono utili, ma vanno usati con testa.
2. Regola d'oro: l'IA aiuta a **capire**, non a copiare o a saltare il ragionamento. La prova del nove e sempre la stessa: so spiegare con parole mie cosa ho fatto e perche.
3. Onesta: quando si usa l'IA per un lavoro, lo si dichiara. Consegnare come proprio un testo fatto interamente dall'IA non e un lavoro proprio.
4. Verifica: l'IA puo sbagliare o inventare (le cosiddette "allucinazioni"). Le sue risposte, soprattutto date, numeri e fonti, vanno controllate.
...
## 8. Comportamenti non consentiti (in breve) {#doc11-sec8}
1. Usare l'account o lo spazio di un altro, o condividere la propria password.
2. Installare programmi, cambiare impostazioni o manomettere le postazioni senza il docente.
...
## 9. In caso di uso scorretto {#doc11-sec9}
1. Prima di tutto se ne parla: spesso e un errore o una leggerezza, e si corregge.
2. Se serve, si applicano le misure previste dal regolamento d'istituto.

> [BLU] Da definire con la scuola: la scala delle conseguenze (richiamo, nota, ecc.) segue il regolamento d'istituto. Qui si rimanda ad esso, non lo si duplica.

## 10. Modulo di presa visione e accettazione {#doc11-sec10}
Da compilare e firmare. Per gli allievi minorenni firma anche un genitore o il tutore.

1. Io sottoscritto/a (allievo/a) ......................................................, della classe ..................,
   dichiaro di aver letto e compreso questo regolamento e di accettarne il rispetto.
   1. Firma dell'allievo/a ...................................................... Data ......................
2. Per gli allievi minorenni. Il/la sottoscritto/a ......................................................,
   genitore o tutore dell'allievo/a sopra indicato/a, dichiara di aver preso visione del regolamento.
   1. Firma del genitore o tutore ...................................................... Data ......................

> [GIALLO] Nota organizzativa: per la raccolta in classe, il docente distribuisce un foglio con l'elenco degli allievi e le colonne per le firme (allievo, genitore, data). Quel foglio con i nomi non va nel repository (dati di minori): resta un documento cartaceo/di classe.

## 11. Collegamenti {#doc11-sec11}
...
# Ruoli della Classe {#doc12}
*Versione 0.4 · 02/09/2026 · Parte: Riferimento*

## 1. Perche i ruoli (il senso) {#doc12-sec1}
...
## 3. Il Rallentatore (ruolo chiave) {#doc12-sec3}
...
## 4. I ruoli adottati (validi per tutti e quattro gli anni) {#doc12-sec4}
...
## 5. Altri ruoli possibili (in futuro, non adottati ora) {#doc12-sec5}
...
## 6. Attenzioni (dato il contesto) {#doc12-sec6}
...
## 8. Assegnazione dei ruoli per classe (scheda da portare in classe) {#doc12-sec8}
...
## 3. Durante l'anno / a fine anno {#doc13-sec3}
...
## Natura dell'Allegato A (importante): documento vivo, per classe {#doc14-sec1}
...
## Cosa sono davvero (verificato leggendo i PDF) {#doc14-sec2}
...
## Identificazione: ogni Allegato A ha CLASSE e ANNO {#doc14-sec3}
...
## Come si usa l'Allegato A durante l'anno (convenzione del docente) {#doc14-sec5}
...
## Cosa si produce a fine anno (documento per la Regione) — DELIVERABLE {#doc14-sec6}
...
# Argomenti Svolti (anno precedente 2025/26) {#doc15}
...
## Classe 2 (2026/27) — argomenti svolti quando era la 1a, a.f. 2025/26 {#doc15-sec1}
### Informatica e Laboratorio (materia unica) — 309 ore, 196 argomenti

**1. Attività trasversali, valutazione e organizzazione**
 **1.1 Accoglienza e organizzazione**
1. Regole laboratorio. Dominio, GSuite (1h)
2. Conoscenza classe (1h)
3. Classroom (1h)
4. Andamento classe e prossimi passi (1h)
5. Cambio posti (1h)
 **1.2 Ripassi ed esercitazioni generiche**
1. Ripasso (2h)
2. Domande e risposte in vista della verifica (1h)
3. Quiz Informatica (2h)
4. Panquiz informatica (1h)
5. PanQuiz (1h)
6. Esercitazione libera (2h)
7. Ripasso e punto sul programma (1h)
 **1.3 Verifiche, interrogazioni e correzioni**
1. Verifica (1h)
2. Correzione verifica di Tecnologia (1h)
3. Interrogazione (7h)
4. Correzione compiti (4h)
 **1.4 Prosecuzione e recupero lavori**
1. Prosecuzione lavoro assegnato (24h)
2. Controllo lavori svolti (1h)
3. Recupero lavori svolti (1h)
4. Situazione generale e recupero (3h)

**2. Fondamenti e cultura informatica**
 **2.1 Bit, byte e numerazione**
1. Bit e byte. Classroom (1h)
2. Sistema di numerazione binario. Conversione (1h)
3. Correzione trasformazioni tra base decimale e binaria (1h)
 **2.2 Codifica e glossario**
1. Glossario (1h)
2. Glossario di informatica: formattazione (2h)
3. Glossario informatico (1h)
4. Codice ASCII Lazarus (1h)
 **2.3 Cultura informatica**
1. Analogia Biblioteca PC (1h)
2. Discorso di Steve Jobs (1h)

**3. Hardware del computer**
 **3.1 Componenti e CPU**
1. Componenti PC (2h)
2. CPU (2h)
3. Case, alimentatore e ventole (1h)
4. Bus, northbridge e southbridge (1h)
5. Bus e cicli di clock (2h)
6. L'hardware del PC (1h)
 **3.2 Memorie di massa**
1. Hard disk e SSD (1h)
2. Cache capacità interfaccia velocità rotazione (1h)
3. HDD (1h)
4. Hard disk e configurazione: interrogazione (1h)
 **3.3 Assemblaggio**
1. Assemblaggio PC (9h)
2. Compatibilità componenti PC (1h)
3. Assemblaggio Pc economico (3h)
4. Assemblare e disassemblare un PC (2h)
5. Assemblaggio (1h)
6. Teoria assemblaggio computer (1h)
 **3.4 Configurazione e preventivo**
1. Configurazione PC (2h)
2. Configurazione PC. Interrogazione stampante (1h)
3. Configurazione PC / Sicurezza (1h)
4. Preventivo PC esame (1h)
5. Configurazione PC TOP (2h)
 **3.5 Stampanti**
1. Stampanti laser, ink jet e matrice (1h)
2. Ripasso stampanti (2h)
 **3.6 Ripassi e verifiche hardware**
1. Interrogazione Hardware e reti (1h)
2. Hardware: Quiz (1h)
3. Panquiz a squadre su hardware PC (1h)
4. Ripasso hardware PC e sicurezza (1h)
5. Panquiz HW (1h)
6. Test hardware (1h)

**4. Sistema operativo**
 **4.1 Windows e sistemi operativi**
1. Il supporto e Win 10 (1h)
2. I sistemi operativi (1h)
3. I sistemi operativi: lavoro individuale (2h)
 **4.2 Tab order e navigazione**
1. Tab order e Tab Stop in Windows (2h)
2. Keyboard vs Mouse: taborder (3h)

**5. Produttività digitale (Google e Office)**
 **5.1 Google Documents**
1. Creazione di un documento con Google Documents e invio come allegato (2h)
2. Esercitazione Google Documents (1h)
3. Presentazione lavoro fatto con Document (1h)
 **5.2 Google Moduli**
1. Google Moduli (3h)
2. Questionario Moduli (1h)
3. Google Moduli: creare un quiz (1h)
 **5.3 Fogli ed Excel**
1. Esercitazione fogli (1h)
2. Excel tipi di dati (2h)
3. Excel esercitazione (2h)
4. Creare un foglio con prezzi dinamici basati sui dati anagrafici (2h)
 **5.4 Suite Google e infografica**
1. Lavoro libero con la suite Google (1h)
2. Infografica Ricetta (1h)

**6. Reti**
 **6.1 Domini e DNS**
1. Router DNS Algoritmo (1h)
2. Dominio e registrazione dominio (3h)
3. Compiti domini (1h)
4. Ripasso domini (1h)
5. Interrogazione domini (2h)
 **6.2 Internet e dispositivi di rete**
1. Internet e il Web (1h)
2. Router, Access Point, Powerline, Wifi extender (1h)
3. MoDem, Voip (2h)
4. La rete in casa (1h)
 **6.3 Pacchetti e TCP/IP**
1. Rete di pacchetti (1h)
2. Simulazione di rete e web server (1h)
3. Pacchetti TCP / IP (1h)
4. La rete TCP/IP (1h)
5. La rete TCP/IP. Rete mondiale (1h)
6. La rete TCP/IP. Trasporto di pacchetti (1h)
7. Simulazione protocolli di rete (1h)
8. TCP/IP (1h)
 **6.4 Modello OSI e LAN**
1. Rete modello OSI (3h)
2. Osi Tcp/IP (2h)
3. Rete LAN (3h)
4. Modello OSI ISO (1h)
 **6.5 Quiz sulle reti**
1. Panquiz: RETI (1h)
2. Quiz su TCP IP (1h)
3. Quiz su OSI (1h)

**7. Programmazione (Lazarus)**
 **7.1 Ambiente e concetti base**
1. Software compilato interpretato (1h)
2. Lazarus Hello world (2h)
3. Lazarus correzione quaderno (1h)
4. Lazarus ambiente (1h)
5. Lazarus esercitazione (1h)
6. Compilato interpretato (1h)
7. Lazarus un semplice esempio (1h)
8. Lazarus (2h)
 **7.2 Variabili e tipi di dato**
1. Variabili stringa e integer (1h)
2. Variabili stringa e integer; HArdware stampanti (1h)
3. Stringhe e numeri (2h)
4. Edit e caption (1h)
5. Stringhe e interi (3h)
6. Prova di recupero in classe: gestione stringhe e interi (3h)
7. Le variabili REAL (1h)
8. Le variabili CURRENCY (1h)
9. Le variabili BOOLEAN (1h)
 **7.3 Componenti e interfaccia**
1. Lazarus: Timer (2h)
2. Lazarus: Slide Show (2h)
3. Slide Show (2h)
4. Lazarus TButton (1h)
5. Disegniamo con Lazarus (2h)
 **7.4 Esercizi e giochi**
1. Generazione nome a caso (2h)
2. Prova somma con Lazarus (1h)
3. Lazarus: Calcolatrice + e x (1h)
4. Una calcolatrice per le somme (1h)
5. Cerchiamo di costruire una calcolatrice. Interi e stringhe (ripasso) (1h)
6. Creazione di un gioco in cui si deve indovinare un numero (1h)
7. Lazarus età futura (1h)
8. Quando morirai...progetto LAzarus (2h)
9. Programma di conversione (2h)
10. Comandi ciechi (1h)
11. Acchiappa la Talpa con Lazarus (2h)
12. Lazarus anagrammi (1h)
13. Esercitazione lazarus numero a caso (2h)
 **7.5 Esercitazioni e progetti**
1. Esercizio Lazarus (2h)
2. Esercitazione Lazarus (4h)
3. Progetto in autonomia LAzarus (1h)
4. Correzione esercitazione Lazarus (1h)
5. Esercitazione ripasso lazarus (2h)

**8. Grafica e multimedia**
 **8.1 Mappe e rappresentazioni della terra**
1. Rappresentazione 2d della terra (1h)
2. Creazione di immagini su una mappa (2h)
3. Africa e Russia, proviamo a misurarle con Google Earth (1h)
4. Map, Earth. Misure sulla terra (2h)

**9. Intelligenza artificiale**
 **9.1 Creare con l'AI**
1. Inventa una storia con immagini generate con l'ausilio della AI (1h)
2. Correzione lavori Storia (1h)
3. Creazione di un gioco con Claude (1h)
4. Creazione di gioco con HTML e AI (1h)
 **9.2 Ricerche e studio dell'AI**
1. Ricerca con AI relazione attacco IRAN (1h)
2. Ai in inglese (1h)
3. Allucinazioni e AI (1h)
4. Lavoro individuale intelligenza artificiale (1h)
5. Intelligenza artificiale (2h)
6. Lavoro con la AI: ricerca sulla AI embedded, senza l'aiuto del docente (1h)

**10. Cittadinanza digitale e media**
 **10.1 Fake news e informazione**
1. Fake news (1h)
2. Come sospettare delle Fake News (1h)
3. Video sicure e setting YouTube (1h)
 **10.2 Social, ban e bot**
1. Spam, Ban, Uk Apple (2h)
2. Bot sui social (1h)
3. Simuliamo il BAN da parte di un moderatore sulla chat e su un social (1h)
4. Lavoro su BAN e BOT (1h)
5. Social media PAnquiz (1h)
6. Interrogazione social media (1h)
 **10.3 Cookie e mobilità digitale**
1. Mobilità e IT (1h)
2. Cookies (2h)
3. Nuova legge monopattino e Portale delll'Automobilista (1h)
4. I cookies (2h)

**11. Mondo del lavoro e impresa simulata**
 **11.1 Professioni e sviluppo software**
1. Software App Web e Legacy Cookie Product , Project Manager Manager (1h)
2. Sviluppo Software (App Web e Legacy, Cookie), Product e Project Mgr (2h)
3. Applicazioni desktop e online. Cookies. Cad Parametrico. Linguaggi di (1h)
4. Sviluppo Software, tipologie e professionisti (1h)
 **11.2 Impresa simulata**
1. Simuliamo ufficio acquisti di un azienda che deve comprare una stampa (1h)
2. Continuazione lavoro sul Brand (1h)
3. Trading virtuale (2h)
4. Statistica PIL e fatturato aziende, con utile per el aziende (1h)
5. Sistemazione magazzino (2h)
6. Business plan eshop (2h)

**12. Attualità, storia e lavori interdisciplinari**
 **12.1 Tecnologia e attualità**
1. Ricerca su Stralink (1h)
2. Ricerca sula storia di Tik Toc (USA) (1h)
3. Starlink, Traduttore, 2G, Rae Roaming (1h)
4. Starlink (1h)
5. Simulazione missione Artemis (2h)
 **12.2 Guerre e storia**
1. Report guerra (3h)
2. Gli imperi nella storia: uso delle Ai e di Word (2h)
3. LAvoro di sintesi ed integrazione utilizzano il racconto De Belo GAlli (3h)
4. Lavoro su pregi e difetti dell'esercito della classe (1h)
5. Lavoro su pregi e difetti dell'esercito di Cesare (1h)
6. Lavoro su pregi e difetti (1h)
 **12.3 Memoria e film**
1. Alien visione (2h)
2. La Giornata della Memoria (1h)
3. Visione Film (2h)

**13. Sicurezza sul lavoro**
 **13.1 Moduli sicurezza**
1. Questionario online Sicurezza (1h)
2. Correzione Sicurezza Ora 2 (1h)
3. Google moduli Correzione sicurezza (1h)
4. Sicurezza ora 5 (1h)
5. Sicurezza ora 6 Meccanici generali Elettrici generali (1h)
6. Sistemi di sicurezza elettrica (1h)

### Sicurezza — 33 ore, 30 argomenti

**1. Attività trasversali, valutazione e organizzazione**
 **1.1 Ripassi e verifiche**
1. MATEMATICA: ripasso per la verifica (1h)
2. Interrogazione (2h)
3. Correzione compiti - PanQuiz (1h)
 **1.2 Organizzazione e lavori**
1. Prosecuzione lavoro assegnato (3h)
2. Situazione classe (1h)
3. Recupero lavori svolti (1h)

**2. Fondamenti e cultura informatica**
 **2.1 Glossario**
1. Glossario informatico (1h)

**3. Hardware del computer**
 **3.1 Assemblaggio e configurazione**
1. Assemblaggio PC (1h)
2. Configurazione PC TOP: alimentatorre e potenza (1h)
 **3.2 Ripassi e quiz hardware**
1. Panquiz: HArdware (1h)
2. Ripasso hardware PC e sicurezza (1h)

**4. Produttività digitale (Google e Office)**
 **4.1 Google e Office**
1. Compito Google documents, finalizzazione (1h)
2. Excel tipi di dati (1h)

**5. Programmazione (Lazarus)**
 **5.1 Componenti ed esercizi**
1. Timer (1h)
2. Creazione di un gioco in cui si deve indovinare un numero (1h)
3. LAvagna con Lazarus (1h)
4. Correzione compito LAzarus (1h)
5. Disegnamo con Lazarus (1h)

**6. Sicurezza informatica (cybersecurity)**
 **6.1 Protezione dati e protocolli**
1. Reti e Cybersecurity (1h)
2. Protezione dei file (1h)
3. DNS, FTP e prorocolli di rete (1h)

**7. Intelligenza artificiale**
 **7.1 AI e strumenti**
1. Intelligenza artificiale (1h)
2. Gemini e l'atomo (1h)

**8. Mondo del lavoro e impresa simulata**
 **8.1 Professioni e impresa**
1. Software App Web e Legacy Cookie Product , Project Manager Manager (1h)
2. Business plan eshop (1h)

**9. Attualità, storia e lavori interdisciplinari**
 **9.1 Storia**
1. Correzione: Gli imperi nella storia: uso delle Ai e di Word (1h)

**10. Sicurezza sul lavoro**
 **10.1 Moduli sicurezza**
1. ORA 1: Concetti di rischio e danno (1h)
2. Sicurezza Ora 2 : Prevenzione e protezione (1h)
3. Sicurezza ora 3 Organizzazione della prevenzione aziendale (1h)
4. Sicurezza ora 4 Organi di vigilanza , controllo e assistenza (1h)


## Classe 3 (2026/27) — argomenti svolti quando era la 2a, a.f. 2025/26 {#doc15-sec2}
### Informatica e Laboratorio (materia unica) — 208 ore, 132 argomenti

**1. Attività trasversali, valutazione e organizzazione**
 **1.1 Accoglienza e avvio anno**
1. Accoglienza (1h)
2. Programma secondo anno (1h)
3. Regolamento laboratorio (1h)
4. Presentazione classe all'insegnate di sostegno (1h)
 **1.2 Ripassi, comprensione e prosecuzione**
1. Ripasso (2h)
2. Prosecuzione lavoro assegnato (17h)
3. Comprensione (1h)
 **1.3 Verifiche, quiz e correzioni**
1. Correzione verifica (1h)
2. Preparazione verifica (1h)
3. Verifica (1h)
4. Quiz con PanQuiz (3h)
5. Prova INVALSI (3h)
 **1.4 Stage**
1. Stage (1h)

**2. Fondamenti e cultura informatica**
 **2.1 Algoritmi e codici**
1. Algoritmo CRC del CF (1h)

**3. Hardware del computer**
 **3.1 Componenti e assemblaggio**
1. Assemblaggio PC (3h)
2. Componenti del PC (2h)
 **3.2 Memorie e configurazione**
1. Dischi RAID e partizione (1h)
2. Configurazione PC (2h)
 **3.3 Upgrade e ripasso**
1. Scheda intervento upgrade PC (2h)
2. Ripasso hardware (2h)

**4. Sistema operativo**
 **4.1 Interfaccia e coordinate Windows**
1. Coordinate windows (1h)
2. UI Windows (2h)
3. Informatica Path (1h)

**5. Reti**
 **5.1 Dominio, Internet e infrastruttura**
1. Dal Dominio all'indirizzo IP (2h)
2. Internet: hardware e software. Lavoro in classe (1h)
3. Internet: hardware e software (1h)
4. Switch di rete (2h)
 **5.2 Reti locali e apparati**
1. Rete lan classe (2h)
2. Rete con Access Point (1h)
3. Recupero Sicurezza. Principi di rete (1h)
 **5.3 Modello OSI e TCP/IP**
1. Modello OSI (1h)
2. Interrogazione OSI (1h)
3. Modello OSI Tcp/Ip (1h)
4. Creiamo un applicazione HTML sul tema modello OSI (1h)
5. Quiz sulle reti (1h)
 **5.4 Simulazioni e web server (Cisco)**
1. Slide Show (2h)
2. Slide Show Cisco PT YouTube (1h)
3. Simulazione Cisco Packet Tracer (1h)
4. Rete e Web Server (1h)

**6. Programmazione (Lazarus)**
 **6.1 Componenti e interfaccia**
1. Coordinate windows con Lazarus (1h)
2. Lazarus tipi di file (1h)
3. Radiobutton e Radiogroup con Lazarus (1h)
4. Radiogroup e CheckGroup uso in Windows con Lazarus (1h)
5. Radiogroup e CheckGroup (1h)
6. Lazarus Combobox (2h)
7. Lazarus PageControl (1h)
8. Lazarus Pagecontrol (1h)
9. Lazarus TabOrder (2h)
 **6.2 Dati: stringhe, numeri, variabili e random**
1. Lazarus risolutore prodotto notevole (2h)
2. Prodotti notevoli con Lazarus (1h)
3. Stringa e array di caratteri (2h)
4. Numeri e stringhe (1h)
5. Generare un numero a caso (1h)
6. Lazarus Random (1h)
7. Generazione numeri casuali (3h)
8. Edit on change e variabili intere e string (2h)
 **6.3 Progetti e algoritmi**
1. Realizzazione questionario con 3 domande (1h)
2. Implementazione questionario con 3 domande (1h)
3. Valutazione questionario con 3 domande (1h)
4. Esercitazione valutata uso RadioButton (1h)
5. Lazarus funzioni e progetto (3h)
6. Lazarus funzioni (1h)
7. Check Code stringa con Lazarus (3h)
8. Logica Master Mind (2h)
9. Logica Master Mind con Lazarus (2h)
10. Master Mind (1h)
11. Cambio posti Master Mind con Lazarus (1h)
12. Master Mind con Lazarus (2h)
13. Mastermind Lazarus (2h)
14. Lazarus Master Mind testuale (2h)
15. Lazarus master mind (3h)
16. Lazarus: coordinate polari e rettangolari (2h)
17. Lazarus conversione coordinate polari e rettangolari (2h)
18. Lazarus: Torre di Hanoi (2h)
19. Esercitazione Lazarus Rubrica (1h)
20. Lazarus Lavagna (2h)
21. Chat Lazarus (1h)
 **6.4 Ambiente, esercitazioni e interrogazioni**
1. Esercitazione Lazarus di recupero (3h)
2. Lazarus Lavoro in proprio (2h)
3. Rad Studio 12 (1h)
4. Delphi vs Lazarus (2h)
5. Esercitazioni di recupero con Lazarus (2h)
6. LAzarus (1h)
7. Esercitazione Lazarus (1h)
8. Lazarus e test sicurezza (1h)
9. Interrogazione Lazarus (1h)
10. Ripasso Lazarus per interrogazione prossima ora (1h)

**7. Grafica e multimedia**
 **7.1 Computer graphic e grafica 3D**
1. Creazione personale computer graphic (2h)
2. Ripasso computer grafico e equazioni (1h)
3. Grafica 3D e e calcoli (1h)
 **7.2 Terra, mappe e coordinate**
1. Terra e rappresentazioni (2h)
2. Robinson Marcatore (1h)
3. La terra non è piatta. Algoritmi (1h)
4. Conversione tra coordinate tra i vari portali (1h)
5. Sistema di coordinate (1h)
6. Coordinate Google (1h)

**8. Sicurezza informatica (cybersecurity)**
 **8.1 Crittografia e protezione dati**
1. Criptare i dati Serratura numerica (1h)

**9. Intelligenza artificiale**
 **9.1 Lavori con l'AI**
1. Lavoro individuale sull'intelligenza artificiale (2h)

**10. Cittadinanza digitale e media**
 **10.1 Fake news e pubblicità**
1. Fake news: Guerre nel mondo, flottiglia ed altro (1h)
2. LA pubblicita sul Web (2h)
 **10.2 Ban, spam e bot**
1. Ban Spam Uk Apple (2h)
2. Ban Bot (1h)
 **10.3 Mobilità e informatica**
1. Mobilità e informatica (2h)
2. Tavola rotonda sulla mobilità (1h)
3. Consegna lavori tavola rotonda (1h)

**11. Mondo del lavoro e impresa simulata**
 **11.1 Sviluppo software e figure professionali**
1. Software App Web e Legacy Cookie Product , Project Manager Manager (2h)
 **11.2 Economia, industria e mercato**
1. TRading online (1h)
2. Tecnologia e industria (2h)
3. ANALISI MERCATO GLOBALE CON FOGLI (1h)

**12. Attualità, storia e lavori interdisciplinari**
 **12.1 Film e visioni**
1. Visione Film (4h)
2. Visione film "Yesterday" (1h)
 **12.2 Storia e attualità**
1. la Giornata della Memoria (1h)
2. Relazione attacco IRAN (2h)
3. Racconto guerra Iran (1h)
4. Esercitazione interazione nazioni (1h)

**13. Sicurezza sul lavoro**
 **13.1 Concetti base: rischio, danno, prevenzione**
1. Rischi e prevenzione (1h)
2. Sicurezza ora 2 Prevenzione e protezione (1h)
3. sicurezza ora1 Concetti di rischio e danno (1h)
4. sicurezza ora1 (1h)
 **13.2 Rischi specifici**
1. Sicurezza Ora 6 Elettrici Generali (1h)
2. Sicurezza Ora 5 Rischio infortuni (1h)
3. Sicurezza ora 7 macchine - attrezzature (1h)
4. Sicurezza ora 8 Cadute, fumi, esplosioni rischi chimici (1h)
5. Sicurezza ora 9 rischi cancerogeni e biologici (1h)
6. Sicurezza ora 11 Microclima ed illuminazione, Terminali (1h)
 **13.3 Moduli e test sicurezza**
1. Test sicurezza (5h)
2. Sicurezza ora 10 (1h)
3. Sicurezza ora 9 (1h)
4. Sicurezza ora 12 (1h)
5. Sicurezza ora 13 (2h)
6. Sicurezza ora 15 (1h)
7. Sicurezza ora 16 (1h)

### Sicurezza — 16 ore, 16 argomenti

**1. Attività trasversali, valutazione e organizzazione**
 **1.1 Ripassi, correzioni e prosecuzione**
1. Ripasso (1h)
2. C orrezione verifica (1h)
3. Prosecuzione lavoro assegnato (1h)

**2. Hardware del computer**
 **2.1 Assemblaggio**
1. Assemblaggio PC (1h)

**3. Produttività digitale (Google e Office)**
 **3.1 Google Sites**
1. Google Sites (1h)
 ...
 **5.1 Grafica e rappresentazione della Terra**
1. GRafica 2d e 3d (1h)
2. Misure e algoritmi dei continenti (1h)

**6. Sicurezza informatica (cybersecurity)**
 **6.1 CRC e protezione dati**
1. Criptare i dati CRC (1h)
2. CRC su mail (1h)

**7. Cittadinanza digitale e media**
 **7.1 Ban e spam**
1. Ban Spam Uk Apple (1h)

**8. Sicurezza sul lavoro**
 **8.1 Concetti e prevenzione**
...
## Classe 4 (2026/27) — argomenti svolti quando era la 3a, a.f. 2025/26 {#doc15-sec3}
 ...
 **1.2 Ripassi, recuperi e attività varie**
1. Ripasso (1h)
2. Prosecuzione lavoro assegnato (8h)
3. Recupero voto informatica (1h)
4. Visione video (2h)

**2. Produttività digitale (Google e Office)**
 **2.1 Google Workspace (GSuite)**
1. Tool Gsuite: compito su classroom (1h)
2. Tool Gsuite. (1h)
3. Tool Gsuite (1h)

**3. Grafica e multimedia**
 **3.1 Computer graphic e coordinate**
1. Sistema di riferimento grafico (3h)

**4. Hardware del computer**
 **4.1 Assemblaggio e scheda madre**
1. Connessione Motherboard M83 (3h)
2. Assemblaggio PC (1h)
 **4.2 Configurazione PC**
1. Prova d'esame configurazione PC (3h)

**5. Reti**
 **5.1 Protocolli e indirizzamento**
1. TCP UDP (1h)
 **5.2 Architettura di rete**
1. Architettura di rete (3h)

**6. Programmazione (Lazarus)**
 **6.1 Esercizi e prove con Lazarus**
1. Programma con Lazarus simulazione d'esame (1h)
2. Aiuto su realizzazione di un programma semplice con LAzarus (1h)
3. Interrogazione Lazarus (3h)

**7. Intelligenza artificiale**
 **7.1 Uso dell'AI nei lavori**
1. Lavoro con supporto AI: crea scenario FantaGeoPolitico (2h)
2. Uso AI (1h)

**8. Mondo del lavoro e orientamento**
 **8.1 Orientamento e comportamento professionale**
1. orientatalenti (6h)
2. Comportamento in classe e sul luogo del lavoro (1h)
3. Customer Review (1h)

**9. Progetti, tesine e stage**
 **9.1 Impostazione e scelta della tesina**
1. Preparazione lavoro individuale tesina (3h)
2. Assegnazione titoli Tesina (3h)
3. Scelta argomenti tesina (1h)
4. Analisi tecnologica temi tesine (2h)
5. Definizione progetto (1h)
6. Lavoro in Team per definizione progetti (2h)
 **9.2 Sviluppo e avanzamento**
1. Avanzamento progetto (7h)
2. Proseguimento documentazione progetto (2h)
3. Progetto in aula 28 (2h)
4. Tesina individuale progetto (2h)
5. Tesina progetto (1h)
6. Continuazione tesina (3h)
7. Tesina work in progress (1h)
8. Lavoro tesina Proseguimento (3h)
9. Proseguimento Tesina (3h)
10. Avanzamento tesina individuale (3h)
11. Prosecuzione tesina (3h)
12. Situazione tesina/progetto (1h)
13. Continuazione tesina e valutazione del lavoro fino a venerdì (2h)
14. Allineamento modalità di consegna settimanale della tesina (1h)
15. Organizzazione mindmap (1h)
16. Sistemazione Tesina (1h)
17. Lavoro di gruppo sulle Tesine (3h)
18. Tesina finalizzazione (2h)
 **9.3 Presentazione ed esame**
1. Presentazioni progetti esame (1h)
2. Presentazione tesina (3h)
3. Esposizione tesina (2h)
4. Presentazione lavoro esame (1h)
 **9.4 Stage**
1. Rientro Stage (2h)


# INVALSI Grado 10 (2025-2026) — Dati, analisi e note {#doc16}
*Versione 1.1 · 10/09/2026 · Parte: Riferimento*

## 0. A cosa serve questo documento {#doc16-sec1}
1. Trasferisce, in forma completa e autosufficiente, l'analisi della restituzione INVALSI di grado 10 (a.s. 2025-2026).
2. E materiale di lavoro da usare come base per le scelte del corso, non un testo da leggere una volta e basta.
3. Chi lo usa non ha bisogno della chat di origine ne dei file .pptx: i dati chiave sono tutti qui.

## 1. Contesto {#doc16-sec2}
1. Classe rilevata: Seconda 2INFSPE.
2. Percorso: IeFP non statali. Codice scuola: MICF05600C.
3. Studenti: 23. Partecipazione alla prova: 96% (22 su 23).
4. Background familiare mediano: medio-basso. Copertura del questionario background (ESCS): 75%.
5. Nelle tavole le righe "classe", "IeFP non statali" e "istituto" riportano numeri identici: la rilevazione ha interessato un unico gruppo, quindi istituto e classe qui coincidono.
6. Nicola insegna Informatica su prima, seconda, terza e quarta. Conseguenza importante: la prova di grado 10 misura il lavoro svolto in prima e seconda e arriva "a cose fatte"; la leva di intervento non e la classe rilevata, ma le classi che stanno salendo.

## 2. Come si leggono i dati {#doc16-sec3}
1. **Livelli di apprendimento**: INVALSI colloca ogni studente in cinque livelli. I traguardi si considerano raggiunti dai livelli 3, 4 e 5; i livelli 1 e 2 indicano traguardi non raggiunti. Il livello 3 e la soglia di adeguatezza, il 4 e il 5 sono le fasce alte.
2. **Colonna "differenza rispetto a gruppi simili"**: e la colonna decisiva. Non confronta con la media nazionale, ma con scuole che hanno studenti di caratteristiche socio-economiche analoghe: il peso dello svantaggio di partenza e gia neutralizzato. Un valore negativo significa che la classe rende meno di ragazzi con lo stesso punto di partenza altrove.
3. **Numerosita**: con 23 studenti, ogni singolo ragazzo pesa 4,3 punti percentuali. Le percentuali vanno sempre lette insieme ai numeri assoluti.

## 3. Il dato centrale: italiano e matematica in direzioni opposte {#doc16-sec4}

| | Punteggio | Diff. da gruppi simili | Traguardi raggiunti | Lombardia | Nord Ovest | Italia |
|---|---|---|---|---|---|---|
| **Italiano** | 151,2 | **−17,6** | 26,1% (6/23) | 69,0% | 66,3% | 61,3% |
| **Matematica** | 183,6 | **+9,4** | 47,8% (11/23) | 65,1% | 61,7% | 54,6% |

1. Valori riferiti alla classe. A livello di istituto: −17,1 per italiano, +9,7 per matematica.
2. Lo scarto fra le due materie, sulla stessa scala e a parita di background, e di 27 punti.

> [GIALLO] Conseguenza logica da tenere ferma: la spiegazione "sono ragazzi che partono svantaggiati" non regge per l'italiano, perche il confronto con i gruppi simili tiene gia conto dello svantaggio. Gli stessi ragazzi, con lo stesso background, in matematica stanno quasi dieci punti sopra i loro pari e in italiano quasi diciotto sotto.

## 4. Italiano {#doc16-sec5}

| | Liv. 1 | Liv. 2 | Liv. 3 | Liv. 4 | Liv. 5 | Traguardi |
|---|---|---|---|---|---|---|
| **Seconda 2INFSPE** | 9 (39,1%) | 8 (34,8%) | 6 (26,1%) | 0 (0,0%) | 0 (0,0%) | 26,1% |
| Lombardia | 10,9% | 20,1% | 31,2% | 25,0% | 12,9% | 69,0% |
| Nord Ovest | 11,6% | 22,2% | 30,8% | 24,0% | 11,4% | 66,3% |
| Italia | 14,5% | 24,2% | 30,2% | 21,5% | 9,6% | 61,3% |

1. Diciassette studenti su 23 restano sotto la soglia di adeguatezza.
2. Il dato piu notevole e un altro: nessuno supera il livello 3. Le fasce alte sono a zero, contro il 37,9% della Lombardia. In matematica la stessa classe piazza cinque ragazzi al livello 4 o 5.
3. Due letture, entrambe aperte (i dati non permettono di scegliere):
   1. Il tetto e reale: nessuno ha competenze di comprensione del testo oltre la soglia base.
   2. La prova non intercetta cio che questi ragazzi sanno fare: formato, testi lunghi, lettura silenziosa, tempi stretti.
4. La seconda ipotesi non e liquidabile con leggerezza proprio perche gli stessi studenti mostrano eccellenza in matematica. Resta pero un'ipotesi: per verificarla servirebbe il dettaglio degli item, che questa restituzione non contiene.

## 5. Matematica {#doc16-sec6}

| | Liv. 1 | Liv. 2 | Liv. 3 | Liv. 4 | Liv. 5 | Traguardi |
|---|---|---|---|---|---|---|
| **Seconda 2INFSPE** | 8 (34,8%) | 4 (17,4%) | 6 (26,1%) | 3 (13,0%) | 2 (8,7%) | 47,8% |
| Lombardia | 11,0% | 24,0% | 25,7% | 20,4% | 19,0% | 65,1% |
| Nord Ovest | 12,6% | 25,7% | 25,9% | 19,1% | 16,8% | 61,7% |
| Italia | 18,4% | 27,0% | 24,3% | 16,9% | 13,4% | 54,6% |

1. In valore assoluto la classe resta sotto la media regionale, ma il profilo e diverso da quello di italiano: la distribuzione e polarizzata anziche compressa, e la differenza rispetto ai gruppi simili e positiva (+9,4).
2. Non e un risultato da correggere, e un risultato da capire: cio che lo produce e probabilmente trasferibile.

## 6. Regolarita del percorso {#doc16-sec7}

| | Italiano — studenti | Italiano — traguardi | Matematica — studenti | Matematica — traguardi |
|---|---|---|---|---|
| Regolari | 9 | 1 (11,1%) | 8 | 3 (37,5%) |
| Posticipatari | 14 | 5 (35,7%) | 15 | 8 (53,3%) |

1. I posticipatari ottengono risultati migliori dei regolari in entrambe le materie: va contro il senso comune scolastico.
2. Non e spiegabile con i dati disponibili: differenze di due o tre studenti su gruppi piccolissimi, statisticamente fragili; ma il segno e lo stesso in entrambe le materie.

> [BLU] Segnalazione tecnica: i conteggi non coincidono fra le due tavole (9 e 14 in italiano, 8 e 15 in matematica; 22 maschi e 1 femmina in italiano, 21 e 2 in matematica; totale 23 in entrambi i casi). La causa non e ricavabile dai documenti.

## 7. Genere e background familiare — dati NON interpretabili {#doc16-sec8}
1. Genere: le studentesse sono una (o due, secondo la tavola). Il "100% di traguardi raggiunti" della riga femmine e una singola persona.
2. ESCS: le quattro fasce contengono 2, 4, 2 e 1 studente. Percentuali come "0,0%" o "100,0%" descrivono uno o due ragazzi.
3. Origine: tutte le celle N.D. (dato non disponibile).
4. Queste disaggregazioni vanno esplicitamente lasciate fuori da qualunque uso.

## 8. Competenze digitali — la parte che riguarda direttamente il corso {#doc16-sec9}

### 8.1 Quota di studenti che raggiungono i traguardi

| Area | Classe | Lombardia | Nord Ovest | Italia |
|---|---|---|---|---|
| Alfabetizzazione su informazioni e dati | 21 (91,3%) | 90,1% | 89,6% | 87,8% |
| Creazione di contenuti digitali | 18 (78,3%) | 82,0% | 80,7% | 78,0% |
| Comunicazione e collaborazione | 18 (78,3%) | 91,0% | 90,4% | 88,3% |
| Sicurezza | 16 (69,6%) | 86,1% | 85,4% | 83,0% |

### 8.2 Distribuzione per livello

| Area | Base — classe | Base — Lombardia | Intermedio — classe | Avanzato — classe | Avanzato — Lombardia |
|---|---|---|---|---|---|
| Alfabetizzazione su informazioni e dati | 9% | 10% | 48% | 43% | 49% |
| Creazione di contenuti digitali | 22% | 18% | 26% | **52%** | 46% |
| Comunicazione e collaborazione | 22% | 9% | 26% | 52% | 57% |
| Sicurezza | **30%** | 14% | 43% | **26%** | 47% |

### 8.3 Lettura
1. **Creazione di contenuti digitali**: unica area in cui la classe supera la Lombardia sul livello avanzato (52% contro 46%). E l'area del "fare", coerente con l'indirizzo.
2. **Alfabetizzazione su informazioni e dati**: solida, sopra tutti i riferimenti.
3. **Comunicazione e collaborazione**: la testa tiene (52% avanzato contro 57%), ma cinque ragazzi restano al livello base contro una quota regionale del 9%. E un problema di coda: recupero mirato su poche persone.
4. **Sicurezza**: e l'unica area in cui la classe e indietro su tutta la distribuzione, fascia alta compresa. Sette ragazzi al livello base (il doppio della quota lombarda) e solo sei all'avanzato contro quasi la meta in regione.

> [GIALLO] Interpretazione (marcata come tale): quando un'area crolla anche nella fascia alta, di norma non e che gli studenti non ce la facciano, ma che l'argomento non e stato battuto a fondo. E un dato che indica il programma piu che gli studenti. E una lettura, non un fatto ricavabile dai numeri.
...
## 8bis. Il quadro DigComp 2.2 e la mappa dei quesiti di esempio {#doc16-sec10}
...
## 9. Che cosa misura l'area "Sicurezza" nella prova {#doc16-sec11}
...
## 10. Che cosa NON c'e nella restituzione {#doc16-sec12}
...
4. Serie storica: assente. Un solo anno rilevato (2025-2026), primo della serie.
...
## 11. Priorita di intervento individuate {#doc16-sec13}
...
## 12. Note per l'uso didattico sui quattro anni {#doc16-sec14}
...
## 13. Avvertenza (da mantenere in qualunque documento derivato) {#doc16-sec15}
...
## 14. Punti aperti da risolvere {#doc16-sec16}
...
## Classe 4 (2026/27) — storico triennio Operatore {#doc17-sec3}
...
## Classe 4 (2026/27) — anno di qualifica (Tecnico Informatico) {#doc17-sec4}
...
# Programma Preventivo 2026/27 (per competenza) {#doc18}
*Versione 0.4 · 02/09/2026 · Parte: Riferimento*

## Classe 1 (2026/27)  (nuova prima) {#doc18-sec1}
...
## Classe 2 (2026/27)  (ex prima) {#doc18-sec2}
### Competenza 12 — Tecnico-professionale ricorsiva — pianificare le fasi, documentazione, algoritmi, organizzazione
Git di base: versionare, il proprio repository personale, salvare con un commit (tutto visuale)  
...
## Classe 3 (2026/27)  (ex seconda) {#doc18-sec3}
### Competenza 12 — Tecnico-professionale ricorsiva — pianificare le fasi, documentazione, algoritmi, organizzazione
Project management: piano di Gantt, ruoli, pianificazione di un progetto  
Lavoro in team e presentazione del lavoro finito; tesine  
...
## Classe 4 (2026/27)  (ex terza) {#doc18-sec4}
### Competenza 12 — Tecnico-professionale ricorsiva — pianificare le fasi, documentazione, algoritmi, organizzazione
Lavoro in team e presentazione del lavoro finito; tesine  
Documentazione tecnica: manuale utente, relazione, deployment  
Git in team: branch, Pull Request, merge, release (Fase 2)
...
# Programma del Corso {#doc19}
*Versione 0.4 · 26/07/2026 · Parte: Classe 1 — Informatica*

## Che corso è (e che corso NON è) {#doc19-sec1}
...
## Una scatola flessibile, cucita sui ragazzi {#doc19-sec2}
...
## A chi è rivolto e con che spirito {#doc19-sec3}
...
## Il vincolo pratico della scuola: niente installazioni (dove si può) {#doc19-sec4}
...
## Il filo dell'anno (sequenza e periodi indicativi) {#doc19-sec6}
...
## Dove porta: il percorso pluriennale {#doc19-sec7}
...
## Serbatoio di idee extra (competenze spendibili nel lavoro) {#doc19-sec8}
...
## Prossimi passi (roadmap del programma) {#doc19-sec11}
...
## Storia delle versioni (le modifiche fatte) {#doc19-sec12}
...
*Versione 0.1 · 21/09/2026 · Parte: Classe 1 — Informatica*
...
## 1. Che cos'è l'informatica {#doc20-sec2}
...
## 2. Il computer e le sue parti {#doc20-sec3}
...
## 4. Google Suite e Classroom {#doc20-sec5}
...
## 5. GitHub e i repository {#doc20-sec6}
...
## 6. Sicurezza e regole di laboratorio {#doc20-sec7}
...
## 7. Esercitazioni svolte {#doc20-sec8}
...
## 8. Glossario (essenziale) {#doc20-sec9}
...
# Laboratorio 1 — Le tue utenze e le tue aree di lavoro {#doc21}
*Versione 0.1 · 15/09/2026 · Parte: Classe 1 — Informatica*

## 1. Obiettivo della lezione {#doc21-sec1}
1. Ogni allievo entra con la propria utenza nel computer e nell'account Google della scuola.
2. Ognuno trova (o crea) la propria area di lavoro nei due mondi: una cartella personale sul computer e una su Google Drive.
3. Si prova la password, cioe si verifica che funzioni, e si imparano le prime regole di una password sicura.
4. La prima vittoria da portare a casa: "ho un mio spazio e ci entro da solo".

## 2. Che cosa sono un'utenza e un'area (in due parole) {#doc21-sec2}
1. **Utenza** (account): la tua chiave personale per entrare, fatta di un **nome utente** e di una **password**.
2. **Area di lavoro**: la tua "stanza" dove tieni i file, cioe una **cartella solo tua**.
3. Nel nostro laboratorio ci sono **due mondi diversi, con due chiavi diverse**:
   1. Il **computer** (Windows): la tua utenza del PC e una **cartella personale sul server** della scuola (in rete).
   2. **Google**: il tuo account della scuola e **Google Drive**, la tua area nel cloud (cioe su internet).

> [GIALLO] Attenzione a non confonderle: la password del computer e la password di Google sono due chiavi diverse, anche se le usi lo stesso giorno. E come avere la chiave di casa e quella dell'armadietto: aprono porte diverse.

## 3. Prima della lezione — cosa prepara il docente {#doc21-sec3}
1. L'elenco delle utenze del computer (una per allievo) con le password iniziali.
2. Le cartelle personali sul server gia pronte, oppure il permesso e il percorso per crearle.
3. Gli account Google della scuola pronti (o le password reimpostate per chi le ha perse).
4. Questa scheda proiettata, cosi la classe segue passo per passo.

> [BLU] Da confermare con il tecnico di laboratorio prima della lezione: i nomi utente del PC, il percorso esatto della cartella personale in rete, e come si reimposta una password (PC e Google). Questi tre dati rendono la lezione liscia.

## 4. In laboratorio — passo per passo (per gli allievi) {#doc21-sec4}

### 4.1 Entra nel computer (Windows)
1. Alla postazione, nella schermata di accesso, scrivi il tuo **nome utente**.
2. Scrivi la **password iniziale** che ti ha dato il docente.
3. Premi Invio: sei dentro. Prima vittoria!

### 4.2 Prova (e se serve cambia) la password del computer
1. Se il sistema ti chiede di cambiare la password al primo accesso, scegline una **nuova e robusta** (vedi la sezione 6).
2. Sul quaderno annota solo che l'hai cambiata, con la data. NON scrivere la password.

### 4.3 Trova la tua area personale sul computer
1. In basso, sulla barra delle applicazioni, apri **Esplora file** (l'icona della cartella gialla).
2. Nel pannello a sinistra, cerca la tua **cartella personale in rete** (il docente dice il nome e dove si trova).
3. Se non c'e ancora, creala nella posizione indicata dal docente e chiamala esattamente cosi:

```
Cognome_Nome
```

### 4.4 Entra nell'account Google della scuola
1. Apri il **browser** (l'icona di Chrome o del browser della scuola).
2. Nella barra dell'indirizzo in alto, scrivi questo indirizzo e premi Invio:

```
drive.google.com
```

3. Accedi con l'**email della scuola** e la tua **password Google** (ricorda: e diversa da quella del computer).

### 4.5 Crea la tua area su Google Drive
1. In Google Drive, in alto a sinistra, premi il pulsante **Nuovo**.
2. Nel menu che si apre, scegli **Cartella nuova**.
3. Chiamala esattamente cosi:

```
Informatica
```

4. Apri la cartella **Informatica** (doppio clic) e, dentro, crea con lo stesso metodo una sotto-cartella chiamata:

```
Esercizi
```

## 5. Carta e penna — la tua scheda delle coordinate {#doc21-sec5}
1. Sul quaderno, disegna un piccolo schema con le tue coordinate, cosi non le dimentichi:
   1. Nome utente del computer.
   2. Dove si trova la mia cartella personale del computer.
   3. La mia email della scuola.
   4. Il nome della mia cartella su Google Drive.
2. Questo schemino diventa la tua "mappa": la prossima volta entri in un lampo.

> [ROSSO] Regola d'oro: NON scrivere MAI le password sul quaderno, su un foglietto o nello zaino. Le password si tengono a mente (o, piu avanti, in un gestore di password). Un foglietto con la password e come lasciare la chiave nella toppa.

## 6. Prima regola di sicurezza — la password robusta (mini) {#doc21-sec6}
1. Una password forte e **lunga** e **difficile da indovinare**: meglio una frase con parole, numeri e simboli che una parola corta.
2. Non si usa la **stessa** password per il computer e per Google: due porte, due chiavi diverse.
3. La password **non si dice a nessuno**, nemmeno agli amici.

> [GIALLO] Aggancio: su questi temi c'e un quiz che si autocorregge e un laboratorio con una finta mail-truffa (vedi il materiale del Recupero INVALSI). Ottimo per la prossima volta.

## 7. Fallo tuo e Mostralo {#doc21-sec7}
1. **Fallo tuo**: dentro la tua cartella Drive "Informatica", crea un documento e scrivici il tuo nome e una cosa che ti piace. E la tua stanza: mettici qualcosa di tuo.
2. **Mostralo**: fai vedere a un compagno che sai entrare nei due mondi e dove tieni i tuoi file.
3. **La prova del nove**: sai spiegare a voce, con parole tue, la differenza tra l'utenza del computer e quella di Google? Se sai raccontarlo, l'hai capito.

## 8. Se qualcosa non va (piccoli intoppi normali) {#doc21-sec8}
1. La password non viene accettata: controlla maiuscole e minuscole e se e attivo il tasto BLOC MAIUSC (Caps Lock).
2. Non trovi la cartella personale in rete: chiama il docente, forse va creata o il percorso e diverso.
3. Google non ti fa entrare: controlla di usare l'email della **scuola**, non quella personale.

> [GIALLO] Un intoppo non e una figuraccia: capita a tutti, anche ai professionisti. Si chiede aiuto con serenita e si va avanti.

## 9. Cosa faremo dopo (uno sguardo avanti) {#doc21-sec9}
1. Con lo spazio pronto nei due mondi, la prossima volta iniziamo a riempirlo: prime cartelle ordinate e la scelta di cosa costruire.
2. Per farsi venire voglia, si sfoglia insieme il "Menu dei contenitori" (cosa possiamo fare quest'anno e nei prossimi).

## 10. Collegamenti {#doc21-sec10}
1. **REGOLE-LABORATORIO**: come si sta e si lavora in laboratorio.
2. **RECUPERO-INVALSI-esercizi** e **quiz-recupero-invalsi**: password e sicurezza, con quiz e attivita pratiche.
3. **MENU-CONTENITORI**: cosa possiamo fare quest'anno e nei quattro anni.
4. **MAPPA-ARGOMENTI**: Fondamenti (organizzazione del lavoro digitale) e Produttivita digitale (Google Drive).


# Laboratorio 2 — Area logica, Google Suite e Classroom {#doc22}
*Versione 0.1 · 16/09/2026 · Parte: Classe 1 — Informatica*

## 1. Obiettivo della lezione {#doc22-sec1}
1. Ripassare in un minuto le regole della password (aggancio alla sicurezza).
2. Capire cos'e l'area logica e organizzare la propria area con le cartelle ad albero.
3. Fare un giro degli strumenti di Google (Drive, Documenti, Gmail) e salvare un file nella cartella giusta.
4. Entrare in Google Classroom, iscriversi al corso e vedere dove sono materiali e compiti.
5. Prima vittoria: "so dove metto le mie cose e so entrare nel corso".

## 2. Vinci subito — ripasso di sicurezza (5 minuti) {#doc22-sec2}
1. Tre regole in un lampo: password lunga e difficile; non si riusa la stessa; non si dice a nessuno.
2. Attivita veloce: aprire il quiz che si autocorregge (materiale `quiz-recupero-invalsi`) e fare due o tre domande a schermo, tutti insieme.
3. Carta e penna: ognuno scrive sul quaderno una password-frase inventata (che NON usera davvero), per capire com'e fatta una password forte.

## 3. L'area logica — tenere in ordine il proprio spazio {#doc22-sec3}
1. **Che cos'e**: l'area logica e il modo in cui organizzi le tue cose in cartelle, come i cassetti di un armadio. Una cosa al suo posto si ritrova in un attimo.
2. **Cartelle ad albero**: una cartella grande dentro cui stanno cartelle piu piccole (come i rami di un albero). Esempio: `Informatica` dentro cui c'e `Esercizi`.
3. **Regola d'oro dei nomi**: nomi chiari e senza spazi strani; niente "senza titolo (1)". Un nome dice subito cosa c'e dentro.
4. **Bridge da Lazarus**: come salvavi il progetto in una cartella del computer, qui salvi in cartelle ordinate su Drive: stesso concetto, posto nuovo.

> [GIALLO] Prendi appunti / fai lo schema a mano: sul quaderno disegna il tuo "albero" delle cartelle (Informatica -> Esercizi, Quaderno, ...). Un disegno vale piu di mille parole.

## 4. Giro della Google Suite (gli strumenti di Google) {#doc22-sec4}
Sono gli strumenti che la scuola ci da con l'account. Oggi li conosciamo e ne usiamo un paio.
1. **Google Drive**: e il tuo "armadio" nel cloud, dove tieni le cartelle e i file.
2. **Google Documenti**: per scrivere testi (come un quaderno digitale).
3. **Gmail**: la posta della scuola (la useremo per comunicare in modo corretto).
4. **Google Classroom**: l'aula digitale del corso (materiali e compiti). La vediamo nella sezione 6.

### 4.1 Passo per passo — crea e salva il tuo primo documento
1. Nel browser, apri una nuova scheda e vai a questo indirizzo:

```
drive.google.com
```

2. In alto a sinistra, premi il pulsante **Nuovo**.
3. Nel menu, scegli **Documenti Google**.
4. In alto a sinistra, dove c'e scritto "Documento senza titolo", scrivi il nome:

```
La mia prima pagina
```

5. Scrivi dentro una frase a piacere (il tuo nome e una cosa che ti piace).
6. Torna in Drive (la scheda di prima) e controlla che il file sia dentro la cartella **Informatica** creata nel Laboratorio 1; se e fuori, trascinalo dentro.

## 5. Carta e penna — la mappa del mio spazio {#doc22-sec5}
1. Sul quaderno, aggiorna il tuo schema: disegna l'albero delle cartelle e segna dove hai messo "La mia prima pagina".
2. Questo schema entra nel quaderno personale: e il tuo "Mostralo".

## 6. Google Classroom — l'aula digitale del corso {#doc22-sec6}
1. **Che cos'e**: e la classe online del corso. Qui il docente mette materiali, avvisi e compiti; tu li trovi e consegni.
2. **Come si entra** (passo per passo):
   1. Nel browser, apri una nuova scheda e vai a questo indirizzo:
...
```
   ...
   2. Accedi, se richiesto, con l'account della scuola (lo stesso di Drive).
   3. In alto a destra, premi il pulsante **+** ("Aggiungi").
   4. Scegli **Iscriviti al corso**.
   5. Scrivi il codice del corso che ti detta il docente e premi **Iscriviti**.

> [BLU] Da preparare prima della lezione (docente): creare il corso su Google Classroom e avere pronto il CODICE DI ISCRIZIONE da dettare alla classe. In alternativa, invitare gli allievi per email dall'account scuola.

3. **Cosa trovi dentro**:
   1. **Stream** (in italiano "flusso"): gli avvisi del docente.
   2. **Lavori del corso**: i materiali e i compiti da fare.
   3. Quando c'e un compito, si apre, si fa quanto richiesto e si preme **Consegna**.

## 7. Fallo tuo e Mostralo {#doc22-sec7}
1. **Fallo tuo**: dai un tocco personale al tuo documento "La mia prima pagina" (un titolo colorato, una frase tua). E il tuo spazio.
2. **Mostralo**: fai vedere a un compagno che sai creare un file, salvarlo nella cartella giusta ed entrare in Classroom.
3. **La prova del nove**: sai spiegare a voce a cosa serve Drive e a cosa serve Classroom? Se lo sai raccontare, l'hai capito.

## 8. Se qualcosa non va (intoppi comuni) {#doc22-sec8}
1. Non trovo il file appena creato: e in Drive, in alto c'e "Recenti"; oppure controlla di essere nell'account della scuola.
2. Classroom non mi fa iscrivere: controlla di aver scritto bene il codice e di usare l'account della scuola, non quello personale.
3. Ho salvato nella cartella sbagliata: si trascina il file nella cartella giusta, non e un dramma.

> [GIALLO] Un intoppo e normale: si chiede aiuto con serenita e si va avanti. Nessuno si sente stupido, mai.

## 9. Cosa faremo dopo {#doc22-sec9}
1. Con lo spazio in ordine e Classroom attivo, la prossima volta iniziamo a usarli per un'attivita vera (primo esercizio consegnato in Classroom).
2. Per farsi venire voglia, si sfoglia il "Menu dei contenitori" e si sceglie insieme la prossima tappa.

## 10. Collegamenti {#doc22-sec10}
1. `classe-1/laboratorio-01-utenze-e-aree`: il laboratorio precedente (utenze e aree), da cui questo continua.
2. `RECUPERO-INVALSI-esercizi` e `quiz-recupero-invalsi`: la parte di sicurezza (password, quiz che si autocorregge).
3. `MAPPA-ARGOMENTI`: Fondamenti (organizzazione del lavoro digitale) e Produttivita digitale (Google Workspace).
4. `REGOLAMENTO-STRUMENTI-DIGITALI-IA`: le regole d'uso di account, servizi digitali e IA.


# La Bussola del Lavoro {#doc23}
*Versione 0.2 · 27/07/2026 · Parte: Classe 1 — Informatica*

## La verità di partenza (chi assume a 15-17 anni) {#doc23-sec1}
...
## Cassetto 1 — La testa e il cuore (quello che pesa di più) {#doc23-sec2}
...
## Cassetto 2 — Le mani (le competenze tecniche che si "vendono" subito) {#doc23-sec3}
...
## Cassetto 3 — Le carte (i documenti che fanno la differenza) {#doc23-sec4}
...
## Ingredienti da dosare (come si usa questa bussola) {#doc23-sec6}
...
## Storia delle versioni (per noi) {#doc23-sec7}
...
# Da Far Fare Assolutamente {#doc24}
*Versione 0.2 · 27/07/2026 · Parte: Classe 1 — Informatica*

## 1. Toccare un database vero e scrivere un po' di SQL {#doc24-sec1}
...
## 2. Costruire uno shop e-commerce funzionante (demo) {#doc24-sec2}
...
## Storia delle versioni (per noi) {#doc24-sec3}
...
# Scheda Configuratore PC {#doc25}
*Versione 0.3 · 18/08/2026 · Parte: Classe 1 — Informatica*

## 1. La regola d'oro: si parte dalla scheda madre {#doc25-sec1}
...
## 2. Cosa decide la scheda madre (i vincoli che si propagano) {#doc25-sec2}
...
## 3. L'ordine con cui scegliere i componenti {#doc25-sec3}
...
## 4. Le schede dei componenti (con le crocette di compatibilita) {#doc25-sec4}
...
## 5. Checklist di compatibilita finale {#doc25-sec5}
...
# Il Mio Negozio Online — Guida per i ragazzi {#doc26}
...
## TAPPA 1 — Metti il negozio ONLINE (la prima vittoria) 🌍 {#doc26-sec1}
...
## TAPPA 2 — Collega il database della classe 🗄️ {#doc26-sec2}
...
## TAPPA 3 — Ricevi gli ordini via email 📧 {#doc26-sec3}
...
## Se qualcosa non va 🔧 (succede a tutti) {#doc26-sec6}
...
# Il Mio Negozio Online — Piano-lezione {#doc27}
...
## Prima di iniziare — cosa prepara il prof (una volta sola) {#doc27-sec2}
...
## La scaletta (3 lezioni) {#doc27-sec3}
...
## Canovaccio — spiegare il database dal vivo (10-15 min) {#doc27-sec4}
...
## Se lavori a gruppi (opzionale, 2-4 ragazzi) {#doc27-sec5}
...
## Gestire i ritmi diversi (importante per questa classe) {#doc27-sec6}
...
## Valutazione (coerente col corso) {#doc27-sec7}
...
## Checklist da tenere in aula {#doc27-sec8}
...
# Il Manuale di Godot {#doc28}
*Versione 0.20 · 16/08/2026 · Parte: Corso Godot / GDScript*

## Perché quello che impari qui può cambiarti le cose {#doc28-sec1}
...
## Scheda 1 — Come si valutano i compiti {#doc28-sec2}
...
## Scheda 2 — Scrivere in Markdown {#doc28-sec3}
...
## Scheda 3 — La tua copia del corso, e come consegnare {#doc28-sec4}
...
## Capitolo 0 — Cos'è Godot, il parente di Lazarus {#doc28-sec5}
...
## Capitolo 1 — I 4 concetti base di Godot {#doc28-sec6}
...
## Capitolo 2 — GDScript: il linguaggio {#doc28-sec7}
...
## Capitolo 3 — I mattoncini, uno alla volta {#doc28-sec8}
...
## Capitolo 4 — Costruiamo l'Esercizio 1: il bottone che saluta {#doc28-sec9}
...
![L'editor di Godot con la scena: i nodi Main, bottoneScena ed etichettaScena](manuale/immagini/es1-ambiente.png)
...
![Il gioco che saluta](manuale/immagini/es1-gioca.png)
...
## Capitolo 5 — Costruiamo l'Esercizio 2: muovi il quadrato {#doc28-sec10}
...
![L'editor di Godot con la scena: i nodi Main e quadratoScena](manuale/immagini/es2-ambiente.png)
...
![Il quadrato che si muove](manuale/immagini/es2-gioca.png)
...
## Capitolo 6 — Costruiamo l'Esercizio 3: prendi la moneta {#doc28-sec11}
...
![L'editor di Godot con la scena: i nodi cestinoScena, monetaScena e punteggioScena](manuale/immagini/es3-ambiente.png)
...
![Il gioco della moneta](manuale/immagini/es3-gioca.png)
...
## Capitolo 7 — Costruiamo l'Esercizio 4: acchiappa le stelle {#doc28-sec12}
...
![L'editor di Godot con la scena: i nodi navettaScena, stellaScena, hudScena e gameoverScena](manuale/immagini/es4-ambiente.png)
...
![Acchiappa le stelle: la navetta prende le stelle mentre scendono, con Punti e Vite in alto](manuale/immagini/es4-gioca.png)
...
## Capitolo 8 — Il percorso: dagli esercizi al "progetto boss" {#doc28-sec13}
...
## Changelog del manuale {#doc28-sec15}
...
# Eserciziario di Godot {#doc29}
*Versione 0.15 · 27/07/2026 · Parte: Corso Godot / GDScript*

## Come funziona ogni esercizio {#doc29-sec1}
...
## Esercizio 1 — Il bottone che saluta {#doc29-sec2}
...
![Il bottone che saluta: quando lo premi, la scritta cambia.](manuale/immagini/es1-gioca.png)
...
## Esercizio 2 — Muovi il quadrato {#doc29-sec3}
...
![Il quadrato azzurro che si muove con le frecce.](manuale/immagini/es2-gioca.png)
...
## Esercizio 3 — Prendi la moneta {#doc29-sec4}
...
![Prendi le monete col cestino: il punteggio sale.](manuale/immagini/es3-gioca.png)
...
## Esercizio 4 — Acchiappa le stelle {#doc29-sec5}
...
![La navetta prende le stelle: se ne perdi tre è Game Over.](manuale/immagini/es4-gioca.png)
...
## Esercizio BOSS — Affonda la Bonomi {#doc29-sec6}
...
## Changelog dell'eserciziario {#doc29-sec7}
...
# Quaderno dello Studente (modello) {#doc30}
*Parte: Corso Godot / GDScript*

## Come si usa (semplice) {#doc30-sec1}
...
## PAGINA — Lezione (copia questo blocco ogni volta) {#doc30-sec2}
...
## PAGINA — Il mio gioco (copia questo blocco per ogni esercizio) {#doc30-sec3}
...
# Programma del Corso — Classe 2 {#doc31}
...
## 3. Modulo A — Sistema operativo {#doc31-sec3}
...
## 4. Modulo B — Programmazione con Lazarus {#doc31-sec4}
...
## 5. Modulo C — Grafica e multimedia {#doc31-sec5}
...
## 6. Modulo D — Prime reti {#doc31-sec6}
...
## 7. Modulo E — Mondo del lavoro e Git in team (avvio) {#doc31-sec7}
...
## 8. Modulo F — Progetto Negozio Online (avvio) {#doc31-sec8}
...
# Le Condizioni — SE… ALLORA… (IF/THEN/ELSE) e IFTTT {#doc32}
*Versione 0.1 · 09/09/2026 · Parte: Classe 2 — Informatica*
...
## 2. La parola nuova (glossario) {#doc32-sec2}
...
## 3. Il concetto: "se… allora…" (prima a parole) {#doc32-sec3}
...
## 4. IFTTT — toccare con mano il "se… allora…" {#doc32-sec4}
...
## 5. Le condizioni in Lazarus (if / then / else) {#doc32-sec5}
...
## 6. Le stesse condizioni con Google e con i social {#doc32-sec6}
...
## 7. Esercizio a 4 livelli — "Maggiorenne o no?" {#doc32-sec7}
...
## 8. Altre idee di esercizio (da riempire piu avanti) {#doc32-sec8}
...
# Intelligenza Artificiale — Gem e Agenti Autonomi {#doc33}
*Versione 0.1 · 09/09/2026 · Parte: Trasversale — tutti gli anni*

## 1. A cosa serve e come si usa {#doc33-sec1}
...
## 2. Cos'e un Gem (assistente personalizzato) {#doc33-sec2}
...
## 3. Cos'e un Agente AI (sistema autonomo) {#doc33-sec3}
...
## 4. Il confronto: Gem contro Agente AI {#doc33-sec4}
...
## 5. Come si costruiscono (uno sguardo dietro le quinte) {#doc33-sec5}
...
## 6. Quando usare l'uno o l'altro (conclusione) {#doc33-sec6}
...
## 7. Attivita pratiche (crea il tuo assistente) {#doc33-sec7}
...
## 8. Uso responsabile dell'AI {#doc33-sec8}
...
# Recupero INVALSI — Piano per Colmare le Lacune (DigComp) {#doc34}
*Versione 0.2 · 10/09/2026 · Parte: Trasversale — tutti gli anni*

## 1. Da dove nasce (il collegamento con INVALSI) {#doc34-sec1}
...
2. Deboli: **Sicurezza** (area 4) e, come coda su pochi, **Comunicazione e collaborazione** (area 2).
...
## 2. Le lacune da colmare (non solo sicurezza) {#doc34-sec2}
...
## 3. Cosa misura la prova nella Sicurezza (ed e tutto nostro) {#doc34-sec3}
...
## 4. Il piano per area (contenuti e attivita) {#doc34-sec4}
...
1. **Comunicazione formale**:
   1. Scrivere una mail formale: oggetto, destinatari, CC e CCN, tono, firma (si aggancia alla suite Google gia usata).
   2. Netiquette: come ci si comporta negli spazi digitali condivisi.
2. **Collaborazione strutturata**:
   1. Lavorare in team con strumenti veri (Git e la suite Google): ruoli chiari, contributi che si integrano.
   2. Documenti condivisi: chi scrive cosa, commenti, versioni.
3. **Attivita**: scrivere una mail formale a un destinatario reale simulato; collaborare in due su un documento o su un piccolo repository, ognuno con il suo pezzo.
4. Questa parte e un **recupero mirato**: interessa soprattutto i pochi rimasti indietro, non tutta la classe.

## 5. Come distribuirlo sui quattro anni {#doc34-sec5}
La prova misura prima e seconda, e la leva vera e **la classe che sale**. Quindi non un modulo unico, ma contenuti distribuiti:
1. **Biennio iniziale (prima e seconda)**: credenziali e password, dato personale, permessi delle app, mail formale di base.
2. **Prima della prova di aprile della seconda**: minacce (phishing/malware base), backup, privacy; ripasso a scenari.
3. **Terza e quarta**: la parte piu professionalizzante (gestione account, sicurezza degli strumenti di lavoro, collaborazione strutturata con Git), che si intreccia con la sicurezza informatica tecnica.

## 6. Come misurare il recupero {#doc34-sec6}
1. **Quiz a scenario** in stile DigComp (a crocette), prima e dopo il modulo, per vedere il progresso.
2. **Autovalutazione** semplice dell'allievo ("cosa farei se…").
3. **La prossima rilevazione INVALSI**: se l'intervento e messo sulla classe giusta (quella che sale), il segno si dovrebbe vedere li.

## 7. Caveat e punti aperti {#doc34-sec7}
...
4. **Corso HTML/CSS e troubleshooting**: i quiz a scenario possono diventare pagine web che si autocorreggono.
5. **Metodo del corso**: scenari concreti, vittoria subito, si mostra, carta e penna.


# Recupero INVALSI — Schede ed Esercizi (Sicurezza e Comunicazione) {#doc35}
*Versione 0.1 · 10/09/2026 · Parte: Trasversale — tutti gli anni*

## 1. Come si usa questo materiale (guida per il docente) {#doc35-sec1}
...
## 2. Prima di iniziare: lo schema "rischio -> cosa faccio" (carta e penna) {#doc35-sec2}
...
## 3. Tema 1 — Password robusta (dimensione 4.1, livello base) {#doc35-sec3}
...
## 4. Tema 2 — Dispositivo su rete non sicura (dimensione 4.1, livello base) {#doc35-sec4}
...
## 5. Tema 3 — E-mail sospetta e phishing (dimensione 4.1, livello intermedio) {#doc35-sec5}
...
## 6. Tema 4 — Cookie e tracciamento (dimensione 4.2, livello intermedio) {#doc35-sec6}
...
## 7. Tema 5 — Richieste di dati di pagamento (dimensione 4.2, livello avanzato) {#doc35-sec7}
...
## 8. Comunicazione e collaborazione (area 2, la coda) {#doc35-sec8}
...
## 8bis. Laboratorio pratico — attivita reali (guidate dal docente) {#doc35-sec9}
...
## 9. Attivita "Fallo tuo" e "Mostralo" {#doc35-sec10}
...
## 10. Prova iniziale e finale (misura del recupero) {#doc35-sec11}
...
## 11. Soluzioni e spiegazioni {#doc35-sec12}
...
# Programma del Corso — Classe 3 {#doc36}
...
## 3. Modulo A — Reti, livello operativo {#doc36-sec3}
...
## 4. Modulo B — Database e SQL {#doc36-sec4}
...
## 5. Modulo C — Web: HTML, CSS e siti {#doc36-sec5}
...
## 6. Modulo D — Programmazione (consolidamento) {#doc36-sec6}
...
## 7. Modulo E — Git in team (Fase 2) {#doc36-sec7}
...
## 8. Modulo F — Hardware, sistema operativo e diagnosi (ripresa per la qualifica) {#doc36-sec8}
...
## 9. Modulo G — Preventivo e relazione tecnica {#doc36-sec9}
...
## 10. Verso la Classe 4 {#doc36-sec10}
...
## 12. Materiale collegato (gia esistente, da trascrivere) {#doc36-sec12}
...
# Le Reti di Computer — Teoria {#doc37}
*Versione 0.2 · 17/08/2026 · Parte: Classe 3 — Informatica*

## 1. Cos'e una rete {#doc37-sec1}
...
## 2. Gli apparecchi di rete in casa {#doc37-sec2}
...
## 4. Hub, switch e routing {#doc37-sec4}
...
## 5. Gli indirizzi in rete {#doc37-sec5}
...
## 6. Il modello ISO/OSI (i 7 livelli) {#doc37-sec6}
...
## 7. Il modello TCP/IP (i 4 livelli) {#doc37-sec7}
...
## 8. Come viaggiano i pacchetti {#doc37-sec8}
...
## 9. Due modi di spedire i dati: TCP e UDP {#doc37-sec9}
...
## 10. Dalla teoria alla pratica {#doc37-sec10}
...
# Cablaggio RJ45 — Scheda pratica {#doc38}
*Versione 0.1 · 17/08/2026 · Parte: Classe 3 — Informatica*

## Esercizio 1 — Costruire un cavo di rete diretto (RJ45) {#doc38-sec1}
...
# Troubleshooting Pratico — Guasti da Creare e Diagnosticare {#doc39}
*Versione 0.1 · 03/09/2026 · Parte: Classe 3 — Informatica*

## 1. A cosa serve e come si usa {#doc39-sec1}
...
## 2. Sicurezza prima di tutto (VINCOLANTE) {#doc39-sec2}
...
## 3. Il metodo di diagnosi (la scheda dell'allievo) {#doc39-sec3}
...
## 4. Catalogo dei guasti fisici (per il docente) {#doc39-sec4}
...
## 5. La parte teorica a crocette (banca domande) {#doc39-sec5}
...
## 6. Come valutare (griglia semplice) {#doc39-sec6}
...
# Corso Base di HTML5 e CSS {#doc40}
*Versione 0.1 · 03/09/2026 · Parte: Classe 3 — Informatica*

## 1. A cosa serve e come si usa {#doc40-sec1}
...
## 2. Cosa serve (senza installare niente) {#doc40-sec2}
...
## 3. La prima vittoria: una pagina in 10 minuti {#doc40-sec3}
...
## 4. HTML5 — la struttura (i mattoni) {#doc40-sec4}
...
## 5. CSS — l'aspetto (colori, caratteri, spazi) {#doc40-sec5}
...
## 6. Una pagina che si vede bene anche sul telefono {#doc40-sec6}
...
## 7. Pubblicare online con GitHub Pages (Mostralo) {#doc40-sec7}
...
## 8. Idee di progetto (Fallo tuo) {#doc40-sec8}
...
# Programma del Corso — Classe 4 {#doc41}
*Versione 0.2 · 18/08/2026 · Parte: Classe 4 — Informatica*

## 1. A colpo d'occhio {#doc41-sec1}
...
## 2. Gli argomenti dell'anno (dalla griglia) {#doc41-sec2}
...
## 3. Modulo A — Cisco Packet Tracer: la rete di una scuola {#doc41-sec3}
...
## 4. Modulo B — Sicurezza di rete {#doc41-sec4}
...
## 5. Modulo C — Database avanzato {#doc41-sec5}
...
## 6. Modulo D — Web: sito completo {#doc41-sec6}
...
## 7. Modulo E — Programmazione (livello massimo) {#doc41-sec7}
...
## 8. Modulo F — Collaudo e documentazione {#doc41-sec8}
...
## 11. La prova di qualifica (diploma) {#doc41-sec11}
...
## 13. Materiale collegato (gia esistente, da trascrivere) {#doc41-sec13}
...
# Corso Informatica — indice generale {#doc42}
...
## Parte 0 — Documenti di pianificazione (trasversali ai quattro anni) {#doc42-sec2}
...
## Parte 1 — Classe 1 (Informatica) {#doc42-sec3}
...
## Parte 2 — Corso Godot / GDScript {#doc42-sec4}
...
## Parte 3 — Materiale del triennio (esami · griglie · rubriche) {#doc42-sec5}
...
## Parte 4 — Strumenti e configurazione {#doc42-sec6}
...
# Materiale del Corso — Classe 1 {#doc43}
...
## 1. Documenti di programmazione (per il docente) {#doc43-sec2}
...
## 2. Esercizi / progetti FATTI {#doc43-sec3}
...
## 2b. Schede e attività pronte (settembre 2026) {#doc43-sec4}
...
## 4. In preparazione (prossimi passi) {#doc43-sec6}
