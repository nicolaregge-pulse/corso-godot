...
# Ruoli della Classe {#doc11}
*Versione 0.4 · 02/09/2026 · Parte: Riferimento*

## 1. Perche i ruoli (il senso) {#doc11-sec1}
...
## 3. Il Rallentatore (ruolo chiave) {#doc11-sec3}
...
## 4. I ruoli adottati (validi per tutti e quattro gli anni) {#doc11-sec4}
...
## 5. Altri ruoli possibili (in futuro, non adottati ora) {#doc11-sec5}
...
## 6. Attenzioni (dato il contesto) {#doc11-sec6}
...
## 8. Assegnazione dei ruoli per classe (scheda da portare in classe) {#doc11-sec8}
...
# Promemoria — Cose da Fare (Nicola) {#doc12}
*Versione 0.3 · 02/09/2026 · Parte: Riferimento*

## 1. Come funziona {#doc12-sec1}
...
## 2. Da fare (inizio scuola e primo periodo) {#doc12-sec2}
...
## 3. Durante l'anno / a fine anno {#doc12-sec3}
...
## 4. Il primo giorno di scuola: 14 settembre 2026 {#doc12-sec4}
...
## Cosa sono davvero (verificato leggendo i PDF) {#doc13-sec2}
...
## Identificazione: ogni Allegato A ha CLASSE e ANNO {#doc13-sec3}
...
## Come si usa l'Allegato A durante l'anno (convenzione del docente) {#doc13-sec5}
...
## Cosa si produce a fine anno (documento per la Regione) — DELIVERABLE {#doc13-sec6}
...
# Argomenti Svolti (anno precedente 2025/26) {#doc14}
*Versione 0.3 · 02/09/2026 · Parte: Riferimento*

> [GIALLO] La Classe 1 (2026/27) e nuova: non ha argomenti dell'anno precedente in questo elenco.


## Classe 2 (2026/27) — argomenti svolti quando era la 1a, a.f. 2025/26 {#doc14-sec1}
...
## Classe 3 (2026/27) — argomenti svolti quando era la 2a, a.f. 2025/26 {#doc14-sec2}
...
## Classe 4 (2026/27) — argomenti svolti quando era la 3a, a.f. 2025/26 {#doc14-sec3}
...
## 2. Come si leggono i dati {#doc15-sec3}
...
## 3. Il dato centrale: italiano e matematica in direzioni opposte {#doc15-sec4}
...
## 6. Regolarita del percorso {#doc15-sec7}
...
## 7. Genere e background familiare — dati NON interpretabili {#doc15-sec8}
...
## 8. Competenze digitali — la parte che riguarda direttamente il corso {#doc15-sec9}
...
## Classe 4 (2026/27) — storico triennio Operatore {#doc16-sec3}
...
## Classe 4 (2026/27) — anno di qualifica (Tecnico Informatico) {#doc16-sec4}
...
# Programma Preventivo 2026/27 (per competenza) {#doc17}
*Versione 0.4 · 02/09/2026 · Parte: Riferimento*

## Classe 1 (2026/27)  (nuova prima) {#doc17-sec1}
...
## Classe 2 (2026/27)  (ex prima) {#doc17-sec2}
### Competenza 12 — Tecnico-professionale ricorsiva — pianificare le fasi, documentazione, algoritmi, organizzazione
Git di base: versionare, il proprio repository personale, salvare con un commit (tutto visuale)  
...
## Classe 3 (2026/27)  (ex seconda) {#doc17-sec3}
### Competenza 12 — Tecnico-professionale ricorsiva — pianificare le fasi, documentazione, algoritmi, organizzazione
Project management: piano di Gantt, ruoli, pianificazione di un progetto  
Lavoro in team e presentazione del lavoro finito; tesine  
...
## Classe 4 (2026/27)  (ex terza) {#doc17-sec4}
### Competenza 12 — Tecnico-professionale ricorsiva — pianificare le fasi, documentazione, algoritmi, organizzazione
Lavoro in team e presentazione del lavoro finito; tesine  
Documentazione tecnica: manuale utente, relazione, deployment  
Git in team: branch, Pull Request, merge, release (Fase 2)
...
# Programma del Corso {#doc18}
*Versione 0.4 · 26/07/2026 · Parte: Classe 1 — Informatica*

## Che corso è (e che corso NON è) {#doc18-sec1}
...
## Una scatola flessibile, cucita sui ragazzi {#doc18-sec2}
...
## A chi è rivolto e con che spirito {#doc18-sec3}
...
## Il vincolo pratico della scuola: niente installazioni (dove si può) {#doc18-sec4}
...
## Il filo dell'anno (sequenza e periodi indicativi) {#doc18-sec6}
...
## Dove porta: il percorso pluriennale {#doc18-sec7}
...
## Serbatoio di idee extra (competenze spendibili nel lavoro) {#doc18-sec8}
...
## Prossimi passi (roadmap del programma) {#doc18-sec11}
...
## Storia delle versioni (le modifiche fatte) {#doc18-sec12}
...
# Laboratorio 1 — Le tue utenze e le tue aree di lavoro {#doc19}
*Versione 0.1 · 15/09/2026 · Parte: Classe 1 — Informatica*

## 1. Obiettivo della lezione {#doc19-sec1}
...
## 2. Che cosa sono un'utenza e un'area (in due parole) {#doc19-sec2}
...
## 3. Prima della lezione — cosa prepara il docente {#doc19-sec3}
...
## 4. In laboratorio — passo per passo (per gli allievi) {#doc19-sec4}
...
## 5. Carta e penna — la tua scheda delle coordinate {#doc19-sec5}
...
## 6. Prima regola di sicurezza — la password robusta (mini) {#doc19-sec6}
...
## 7. Fallo tuo e Mostralo {#doc19-sec7}
...
## 8. Se qualcosa non va (piccoli intoppi normali) {#doc19-sec8}
...
## 9. Cosa faremo dopo (uno sguardo avanti) {#doc19-sec9}
...
# La Bussola del Lavoro {#doc20}
*Versione 0.2 · 27/07/2026 · Parte: Classe 1 — Informatica*

## La verità di partenza (chi assume a 15-17 anni) {#doc20-sec1}
...
## Cassetto 1 — La testa e il cuore (quello che pesa di più) {#doc20-sec2}
...
## Cassetto 2 — Le mani (le competenze tecniche che si "vendono" subito) {#doc20-sec3}
...
## Cassetto 3 — Le carte (i documenti che fanno la differenza) {#doc20-sec4}
...
## Ingredienti da dosare (come si usa questa bussola) {#doc20-sec6}
...
## Storia delle versioni (per noi) {#doc20-sec7}
...
# Da Far Fare Assolutamente {#doc21}
*Versione 0.2 · 27/07/2026 · Parte: Classe 1 — Informatica*

## 1. Toccare un database vero e scrivere un po' di SQL {#doc21-sec1}
...
## 2. Costruire uno shop e-commerce funzionante (demo) {#doc21-sec2}
...
## Storia delle versioni (per noi) {#doc21-sec3}
...
# Scheda Configuratore PC {#doc22}
*Versione 0.3 · 18/08/2026 · Parte: Classe 1 — Informatica*

## 1. La regola d'oro: si parte dalla scheda madre {#doc22-sec1}
...
## 2. Cosa decide la scheda madre (i vincoli che si propagano) {#doc22-sec2}
...
## 3. L'ordine con cui scegliere i componenti {#doc22-sec3}
...
## 4. Le schede dei componenti (con le crocette di compatibilita) {#doc22-sec4}
...
## 5. Checklist di compatibilita finale {#doc22-sec5}
...
# Il Mio Negozio Online — Guida per i ragazzi {#doc23}
...
## TAPPA 1 — Metti il negozio ONLINE (la prima vittoria) 🌍 {#doc23-sec1}
...
## TAPPA 2 — Collega il database della classe 🗄️ {#doc23-sec2}
...
## TAPPA 3 — Ricevi gli ordini via email 📧 {#doc23-sec3}
...
## Se qualcosa non va 🔧 (succede a tutti) {#doc23-sec6}
...
# Il Mio Negozio Online — Piano-lezione {#doc24}
...
## Prima di iniziare — cosa prepara il prof (una volta sola) {#doc24-sec2}
...
## La scaletta (3 lezioni) {#doc24-sec3}
...
## Canovaccio — spiegare il database dal vivo (10-15 min) {#doc24-sec4}
...
## Se lavori a gruppi (opzionale, 2-4 ragazzi) {#doc24-sec5}
...
## Gestire i ritmi diversi (importante per questa classe) {#doc24-sec6}
...
## Valutazione (coerente col corso) {#doc24-sec7}
...
## Checklist da tenere in aula {#doc24-sec8}
...
# Il Manuale di Godot {#doc25}
*Versione 0.20 · 16/08/2026 · Parte: Corso Godot / GDScript*

## Perché quello che impari qui può cambiarti le cose {#doc25-sec1}
...
## Scheda 1 — Come si valutano i compiti {#doc25-sec2}
...
## Scheda 2 — Scrivere in Markdown {#doc25-sec3}
...
## Scheda 3 — La tua copia del corso, e come consegnare {#doc25-sec4}
...
## Capitolo 0 — Cos'è Godot, il parente di Lazarus {#doc25-sec5}
...
## Capitolo 1 — I 4 concetti base di Godot {#doc25-sec6}
...
## Capitolo 2 — GDScript: il linguaggio {#doc25-sec7}
...
## Capitolo 3 — I mattoncini, uno alla volta {#doc25-sec8}
...
## Capitolo 4 — Costruiamo l'Esercizio 1: il bottone che saluta {#doc25-sec9}
...
## Capitolo 5 — Costruiamo l'Esercizio 2: muovi il quadrato {#doc25-sec10}
...
## Capitolo 6 — Costruiamo l'Esercizio 3: prendi la moneta {#doc25-sec11}
...
## Capitolo 7 — Costruiamo l'Esercizio 4: acchiappa le stelle {#doc25-sec12}
...
## Capitolo 8 — Il percorso: dagli esercizi al "progetto boss" {#doc25-sec13}
...
## Changelog del manuale {#doc25-sec15}
...
# Eserciziario di Godot {#doc26}
*Versione 0.15 · 27/07/2026 · Parte: Corso Godot / GDScript*

## Come funziona ogni esercizio {#doc26-sec1}
...
## Esercizio 1 — Il bottone che saluta {#doc26-sec2}
...
## Esercizio 2 — Muovi il quadrato {#doc26-sec3}
...
## Esercizio 3 — Prendi la moneta {#doc26-sec4}
...
## Esercizio 4 — Acchiappa le stelle {#doc26-sec5}
...
## Esercizio BOSS — Affonda la Bonomi {#doc26-sec6}
...
## Changelog dell'eserciziario {#doc26-sec7}
...
# Quaderno dello Studente (modello) {#doc27}
*Parte: Corso Godot / GDScript*

## Come si usa (semplice) {#doc27-sec1}
...
## PAGINA — Lezione (copia questo blocco ogni volta) {#doc27-sec2}
...
## PAGINA — Il mio gioco (copia questo blocco per ogni esercizio) {#doc27-sec3}
...
# Programma del Corso — Classe 2 {#doc28}
...
## 3. Modulo A — Sistema operativo {#doc28-sec3}
...
## 4. Modulo B — Programmazione con Lazarus {#doc28-sec4}
...
## 5. Modulo C — Grafica e multimedia {#doc28-sec5}
...
## 6. Modulo D — Prime reti {#doc28-sec6}
...
## 7. Modulo E — Mondo del lavoro e Git in team (avvio) {#doc28-sec7}
...
## 8. Modulo F — Progetto Negozio Online (avvio) {#doc28-sec8}
...
# Le Condizioni — SE… ALLORA… (IF/THEN/ELSE) e IFTTT {#doc29}
...
## 2. La parola nuova (glossario) {#doc29-sec2}
...
## 3. Il concetto: "se… allora…" (prima a parole) {#doc29-sec3}
...
## 4. IFTTT — toccare con mano il "se… allora…" {#doc29-sec4}
...
## 5. Le condizioni in Lazarus (if / then / else) {#doc29-sec5}
...
## 6. Le stesse condizioni con Google e con i social {#doc29-sec6}
...
## 7. Esercizio a 4 livelli — "Maggiorenne o no?" {#doc29-sec7}
...
## 8. Altre idee di esercizio (da riempire piu avanti) {#doc29-sec8}
...
# Intelligenza Artificiale — Gem e Agenti Autonomi {#doc30}
...
## 2. Cos'e un Gem (assistente personalizzato) {#doc30-sec2}
...
## 3. Cos'e un Agente AI (sistema autonomo) {#doc30-sec3}
...
## 4. Il confronto: Gem contro Agente AI {#doc30-sec4}
...
## 5. Come si costruiscono (uno sguardo dietro le quinte) {#doc30-sec5}
...
## 6. Quando usare l'uno o l'altro (conclusione) {#doc30-sec6}
...
## 7. Attivita pratiche (crea il tuo assistente) {#doc30-sec7}
...
## 8. Uso responsabile dell'AI {#doc30-sec8}
...
# Recupero INVALSI — Piano per Colmare le Lacune (DigComp) {#doc31}
*Versione 0.2 · 10/09/2026 · Parte: Trasversale — tutti gli anni*

## 1. Da dove nasce (il collegamento con INVALSI) {#doc31-sec1}
...
## 2. Le lacune da colmare (non solo sicurezza) {#doc31-sec2}
...
## 3. Cosa misura la prova nella Sicurezza (ed e tutto nostro) {#doc31-sec3}
...
## 4. Il piano per area (contenuti e attivita) {#doc31-sec4}
...
## 5. Come distribuirlo sui quattro anni {#doc31-sec5}
...
## 6. Come misurare il recupero {#doc31-sec6}
...
## 7. Caveat e punti aperti {#doc31-sec7}
...
# Recupero INVALSI — Schede ed Esercizi (Sicurezza e Comunicazione) {#doc32}
*Versione 0.1 · 10/09/2026 · Parte: Trasversale — tutti gli anni*

## 1. Come si usa questo materiale (guida per il docente) {#doc32-sec1}
...
## 2. Prima di iniziare: lo schema "rischio -> cosa faccio" (carta e penna) {#doc32-sec2}
...
## 3. Tema 1 — Password robusta (dimensione 4.1, livello base) {#doc32-sec3}
...
## 4. Tema 2 — Dispositivo su rete non sicura (dimensione 4.1, livello base) {#doc32-sec4}
...
## 5. Tema 3 — E-mail sospetta e phishing (dimensione 4.1, livello intermedio) {#doc32-sec5}
...
## 6. Tema 4 — Cookie e tracciamento (dimensione 4.2, livello intermedio) {#doc32-sec6}
...
## 7. Tema 5 — Richieste di dati di pagamento (dimensione 4.2, livello avanzato) {#doc32-sec7}
...
## 8. Comunicazione e collaborazione (area 2, la coda) {#doc32-sec8}
...
## 8bis. Laboratorio pratico — attivita reali (guidate dal docente) {#doc32-sec9}
...
## 9. Attivita "Fallo tuo" e "Mostralo" {#doc32-sec10}
...
## 10. Prova iniziale e finale (misura del recupero) {#doc32-sec11}
...
## 11. Soluzioni e spiegazioni {#doc32-sec12}
...
# Programma del Corso — Classe 3 {#doc33}
...
## 3. Modulo A — Reti, livello operativo {#doc33-sec3}
...
## 4. Modulo B — Database e SQL {#doc33-sec4}
...
## 5. Modulo C — Web: HTML, CSS e siti {#doc33-sec5}
...
## 6. Modulo D — Programmazione (consolidamento) {#doc33-sec6}
...
## 7. Modulo E — Git in team (Fase 2) {#doc33-sec7}
...
## 8. Modulo F — Hardware, sistema operativo e diagnosi (ripresa per la qualifica) {#doc33-sec8}
...
## 9. Modulo G — Preventivo e relazione tecnica {#doc33-sec9}
...
## 10. Verso la Classe 4 {#doc33-sec10}
...
## 12. Materiale collegato (gia esistente, da trascrivere) {#doc33-sec12}
...
# Le Reti di Computer — Teoria {#doc34}
*Versione 0.2 · 17/08/2026 · Parte: Classe 3 — Informatica*

## 1. Cos'e una rete {#doc34-sec1}
...
## 2. Gli apparecchi di rete in casa {#doc34-sec2}
...
## 4. Hub, switch e routing {#doc34-sec4}
...
## 5. Gli indirizzi in rete {#doc34-sec5}
...
## 6. Il modello ISO/OSI (i 7 livelli) {#doc34-sec6}
...
## 7. Il modello TCP/IP (i 4 livelli) {#doc34-sec7}
...
## 8. Come viaggiano i pacchetti {#doc34-sec8}
...
## 9. Due modi di spedire i dati: TCP e UDP {#doc34-sec9}
...
## 10. Dalla teoria alla pratica {#doc34-sec10}
...
# Cablaggio RJ45 — Scheda pratica {#doc35}
*Versione 0.1 · 17/08/2026 · Parte: Classe 3 — Informatica*

## Esercizio 1 — Costruire un cavo di rete diretto (RJ45) {#doc35-sec1}
...
# Troubleshooting Pratico — Guasti da Creare e Diagnosticare {#doc36}
...
## 2. Sicurezza prima di tutto (VINCOLANTE) {#doc36-sec2}
...
## 3. Il metodo di diagnosi (la scheda dell'allievo) {#doc36-sec3}
...
## 4. Catalogo dei guasti fisici (per il docente) {#doc36-sec4}
...
## 5. La parte teorica a crocette (banca domande) {#doc36-sec5}
...
## 6. Come valutare (griglia semplice) {#doc36-sec6}
...
# Corso Base di HTML5 e CSS {#doc37}
*Versione 0.1 · 03/09/2026 · Parte: Classe 3 — Informatica*
...
## 2. Cosa serve (senza installare niente) {#doc37-sec2}
...
## 3. La prima vittoria: una pagina in 10 minuti {#doc37-sec3}
...
## 4. HTML5 — la struttura (i mattoni) {#doc37-sec4}
...
## 5. CSS — l'aspetto (colori, caratteri, spazi) {#doc37-sec5}
...
## 6. Una pagina che si vede bene anche sul telefono {#doc37-sec6}
...
## 7. Pubblicare online con GitHub Pages (Mostralo) {#doc37-sec7}
...
## 8. Idee di progetto (Fallo tuo) {#doc37-sec8}
...
# Programma del Corso — Classe 4 {#doc38}
*Versione 0.2 · 18/08/2026 · Parte: Classe 4 — Informatica*

## 1. A colpo d'occhio {#doc38-sec1}
...
## 2. Gli argomenti dell'anno (dalla griglia) {#doc38-sec2}
...
## 3. Modulo A — Cisco Packet Tracer: la rete di una scuola {#doc38-sec3}
...
## 4. Modulo B — Sicurezza di rete {#doc38-sec4}
...
## 5. Modulo C — Database avanzato {#doc38-sec5}
...
## 6. Modulo D — Web: sito completo {#doc38-sec6}
...
## 7. Modulo E — Programmazione (livello massimo) {#doc38-sec7}
...
## 8. Modulo F — Collaudo e documentazione {#doc38-sec8}
...
## 11. La prova di qualifica (diploma) {#doc38-sec11}
...
## 13. Materiale collegato (gia esistente, da trascrivere) {#doc38-sec13}
...
# Corso Informatica — indice generale {#doc39}
...
## Parte 0 — Documenti di pianificazione (trasversali ai quattro anni) {#doc39-sec2}
...
## Parte 1 — Classe 1 (Informatica) {#doc39-sec3}
...
## Parte 2 — Corso Godot / GDScript {#doc39-sec4}
...
## Parte 3 — Materiale del triennio (esami · griglie · rubriche) {#doc39-sec5}
...
## Parte 4 — Strumenti e configurazione {#doc39-sec6}
...
# Materiale del Corso — Classe 1 {#doc40}
...
## 1. Documenti di programmazione (per il docente) {#doc40-sec2}
...
## 2. Esercizi / progetti FATTI {#doc40-sec3}
...
## 4. In preparazione (prossimi passi) {#doc40-sec5}
