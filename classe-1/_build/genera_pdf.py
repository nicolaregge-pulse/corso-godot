...
DOCS = {
    ...
    "allegato-classe-1": {"src": "../allegato-a-2026-27/allegato-a-classe-1.md", "title": "Allegato A 2026/27 — Le mie parti (Regge) — Classe 1"},
    ...
    "scheda-triade": {"src": "../SCHEDA-TRIADE-NOTEBOOKLM-CLASSROOM-GIT.md", "title": "La triade: NotebookLM, Classroom e Git (scheda pronta)"},
