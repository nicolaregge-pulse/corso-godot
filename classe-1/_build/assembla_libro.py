...
LIBRO = [
    ...
    ("Riferimento",            "MENU-CONTENITORI.md",                          "Menu del Corso — I Contenitori dell'Informatica"),
    ...
    ("Riferimento",            "REGOLAMENTO-STRUMENTI-DIGITALI-IA.md",         "Regolamento — Strumenti Informatici, Servizi Digitali e IA Generativa"),
    ...
    ("Classe 1 — Informatica", "classe-1/scheda-configuratore-pc.md",         "Scheda Configuratore PC"),
    ...
    ("Trasversale — tutti gli anni", "RECUPERO-INVALSI.md",                    "Recupero INVALSI — Piano per Colmare le Lacune (DigComp)"),
    ("Trasversale — tutti gli anni", "RECUPERO-INVALSI-esercizi.md",           "Recupero INVALSI — Schede ed Esercizi (Sicurezza e Comunicazione)"),
    ...
    ("Classe 3 — Informatica", "classe-3/troubleshooting-guasti.md",          "Troubleshooting Pratico — Guasti da Creare e Diagnosticare"),
    ("Classe 3 — Informatica", "classe-3/corso-html-css.md",                  "Corso Base di HTML5 e CSS"),
