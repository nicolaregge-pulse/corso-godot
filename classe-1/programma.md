...
> Come si legge questo programma: è la **fotografia dell'anno**, non una lezione.
> Dice **cosa** faremo, in **che ordine** e **perché**, tenendo sempre al centro
> il motore del corso: *Vinci subito · Fallo tuo · Mostralo*. I contenuti veri
> (spiegazioni e schede-esercizio) crescono poi in `manuale.md` e
> `eserciziario.md`, come già facciamo per il corso di Godot.
