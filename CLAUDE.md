...
8l. `classe-1/versioning/versioning.md` (+ `.html` → `Versioning-v2.0.pdf`) — v2.0 (scheda UNICA trilingue: flusso completo delle versioni, major/minor, ripartenza da .0 con nuova linea a ogni release principale; con disegno a due linee)
