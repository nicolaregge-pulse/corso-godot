...
8i2. `classe-1/utenze-password/utenze-password.html` (→ `20260923_Le-Mie-Utenze-Password_multilingua_v1.0.pdf`) — v1.0 (scheda da compilare a penna: utenze e password di computer scuola/Google/GitHub; trilingue IT/AR/ZH, una pagina, con nota di sicurezza "tienila al sicuro")
