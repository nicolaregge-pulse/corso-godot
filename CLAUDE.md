...
5. `REGOLE-NOSTRE-CLAUDE-NICOLA.md` — v1.8 (convenzioni interne Nicola↔Claude: PPP, schema nomi file cronologia/cosa/chi + aree Comune/Docente/Regione, nome deterministico col percorso, conservazione integrale; NON sono le regole per i ragazzi)
