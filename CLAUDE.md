...
8l. `classe-1/versioning/versioning.md` (+ `.html` → `Versioning-v1.0.pdf`) — v1.0 (scheda UNICA trilingue: le versioni — piccole modifiche v1.1/v1.2, cambiamenti importanti v2.0; con disegno; spiega perche i file del corso hanno la versione nel nome)
